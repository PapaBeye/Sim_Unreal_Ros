...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxPlayers = { UE4CodeGen_Private::EPropertyClass::Int, "MaxPlayers", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000044001, 1, nullptr, STRUCT_OFFSET(UGameSessionSettings, MaxPlayers), METADATA_PARAMS(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxPlayers_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxPlayers_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxSpectators = { UE4CodeGen_Private::EPropertyClass::Int, "MaxSpectators", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000044001, 1, nullptr, STRUCT_OFFSET(UGameSessionSettings, MaxSpectators), METADATA_PARAMS(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxSpectators_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxSpectators_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGameSessionSettings_Statics::ClassParams = {
		...
		0x001000A4u,
		nullptr, 0,
		Z_Construct_UClass_UGameSessionSettings_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UGameSessionSettings_Statics::PropPointers),
		"Game",
	...
	IMPLEMENT_CLASS(UGameSessionSettings, 3569008837);
