...
class UScriptStruct* FMovieSceneKeyHandleMap::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MOVIESCENE_API uint32 Get_Z_Construct_UScriptStruct_FMovieSceneKeyHandleMap_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneKeyHandleMap, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneKeyHandleMap"), sizeof(FMovieSceneKeyHandleMap), Get_Z_Construct_UScriptStruct_FMovieSceneKeyHandleMap_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneKeyHandleMap
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FMovieSceneKeyHandleMap_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_MovieScene();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("MovieSceneKeyHandleMap"), sizeof(FMovieSceneKeyHandleMap), Get_Z_Construct_UScriptStruct_FMovieSceneKeyHandleMap_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneKeyHandleMap_CRC() { return 4026380248U; }
