...
class UScriptStruct* FMovieSceneEvaluationOperand::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MOVIESCENE_API uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEvaluationOperand"), sizeof(FMovieSceneEvaluationOperand), Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationOperand
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_Statics::NewProp_ObjectBindingID = { UE4CodeGen_Private::EPropertyClass::Struct, "ObjectBindingID", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneEvaluationOperand, ObjectBindingID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_Statics::NewProp_ObjectBindingID_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_Statics::NewProp_ObjectBindingID_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_MovieScene();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("MovieSceneEvaluationOperand"), sizeof(FMovieSceneEvaluationOperand), Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_CRC() { return 3246539217U; }
