...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneBinding
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_Tracks = { UE4CodeGen_Private::EPropertyClass::Array, "Tracks", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040008000000008, 1, nullptr, STRUCT_OFFSET(FMovieSceneBinding, Tracks), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_Tracks_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_Tracks_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_Tracks_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "Tracks", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0002000000080008, 1, nullptr, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_Tracks_Inner_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_Tracks_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_BindingName = { UE4CodeGen_Private::EPropertyClass::Str, "BindingName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneBinding, BindingName), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_BindingName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_BindingName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_ObjectGuid = { UE4CodeGen_Private::EPropertyClass::Struct, "ObjectGuid", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneBinding, ObjectGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_ObjectGuid_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_ObjectGuid_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneBinding_CRC() { return 4148454951U; }
