...
class UScriptStruct* FMovieSceneChannel::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MOVIESCENE_API uint32 Get_Z_Construct_UScriptStruct_FMovieSceneChannel_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneChannel, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneChannel"), sizeof(FMovieSceneChannel), Get_Z_Construct_UScriptStruct_FMovieSceneChannel_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneChannel
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FMovieSceneChannel_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_MovieScene();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("MovieSceneChannel"), sizeof(FMovieSceneChannel), Get_Z_Construct_UScriptStruct_FMovieSceneChannel_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneChannel_CRC() { return 1013041564U; }
