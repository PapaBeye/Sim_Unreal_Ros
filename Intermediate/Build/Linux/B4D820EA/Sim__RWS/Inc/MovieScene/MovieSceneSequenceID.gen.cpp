...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSequenceID
{
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::NewProp_Value = { UE4CodeGen_Private::EPropertyClass::UInt32, "Value", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneSequenceID, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::NewProp_Value_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::NewProp_Value_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSequenceID_CRC() { return 1184123066U; }
