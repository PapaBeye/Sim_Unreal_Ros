...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneSubTrack_Statics::NewProp_Sections = { UE4CodeGen_Private::EPropertyClass::Array, "Sections", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020088000000008, 1, nullptr, STRUCT_OFFSET(UMovieSceneSubTrack, Sections), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSubTrack_Statics::NewProp_Sections_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSubTrack_Statics::NewProp_Sections_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMovieSceneSubTrack_Statics::NewProp_Sections_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "Sections", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000080008, 1, nullptr, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneSubTrack_Statics::ClassParams = {
		...
		0x00B000A0u,
		nullptr, 0,
		Z_Construct_UClass_UMovieSceneSubTrack_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSubTrack_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMovieSceneSubTrack, 3055594165);
