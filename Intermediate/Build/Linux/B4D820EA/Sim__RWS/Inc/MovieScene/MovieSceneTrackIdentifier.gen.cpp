...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneTrackIdentifier
{
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier_Statics::NewProp_Value = { UE4CodeGen_Private::EPropertyClass::UInt32, "Value", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneTrackIdentifier, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier_Statics::NewProp_Value_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier_Statics::NewProp_Value_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier_CRC() { return 1065647479U; }
