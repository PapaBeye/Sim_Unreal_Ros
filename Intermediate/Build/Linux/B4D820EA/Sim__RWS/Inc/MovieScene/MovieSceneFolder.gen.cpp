...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_FolderColor = { UE4CodeGen_Private::EPropertyClass::Struct, "FolderColor", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000800000001, 1, nullptr, STRUCT_OFFSET(UMovieSceneFolder, FolderColor), Z_Construct_UScriptStruct_FColor, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_FolderColor_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_FolderColor_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildObjectBindingStrings = { UE4CodeGen_Private::EPropertyClass::Array, "ChildObjectBindingStrings", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneFolder, ChildObjectBindingStrings), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildObjectBindingStrings_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildObjectBindingStrings_MetaData)) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildObjectBindingStrings_Inner = { UE4CodeGen_Private::EPropertyClass::Str, "ChildObjectBindingStrings", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks = { UE4CodeGen_Private::EPropertyClass::Array, "ChildMasterTracks", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040008000000008, 1, nullptr, STRUCT_OFFSET(UMovieSceneFolder, ChildMasterTracks), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "ChildMasterTracks", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000080008, 1, nullptr, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildFolders = { UE4CodeGen_Private::EPropertyClass::Array, "ChildFolders", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040008000000008, 1, nullptr, STRUCT_OFFSET(UMovieSceneFolder, ChildFolders), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildFolders_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildFolders_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildFolders_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "ChildFolders", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000080008, 1, nullptr, 0, Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_FolderName = { UE4CodeGen_Private::EPropertyClass::Name, "FolderName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneFolder, FolderName), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_FolderName_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_FolderName_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneFolder_Statics::ClassParams = {
		...
		0x00B000A0u,
		nullptr, 0,
		Z_Construct_UClass_UMovieSceneFolder_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMovieSceneFolder, 1220574837);
