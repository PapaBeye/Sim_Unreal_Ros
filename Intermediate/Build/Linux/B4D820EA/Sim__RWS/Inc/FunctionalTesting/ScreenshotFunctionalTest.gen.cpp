...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AScreenshotFunctionalTest_Statics::NewProp_bCameraCutOnScreenshotPrep = { UE4CodeGen_Private::EPropertyClass::Bool, "bCameraCutOnScreenshotPrep", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010020000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(AScreenshotFunctionalTest), &Z_Construct_UClass_AScreenshotFunctionalTest_Statics::NewProp_bCameraCutOnScreenshotPrep_SetBit, METADATA_PARAMS(Z_Construct_UClass_AScreenshotFunctionalTest_Statics::NewProp_bCameraCutOnScreenshotPrep_MetaData, ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTest_Statics::NewProp_bCameraCutOnScreenshotPrep_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AScreenshotFunctionalTest_Statics::ClassParams = {
		...
		0x009000A0u,
		nullptr, 0,
		Z_Construct_UClass_AScreenshotFunctionalTest_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTest_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(AScreenshotFunctionalTest, 3772465852);
