...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotOptions = { UE4CodeGen_Private::EPropertyClass::Struct, "ScreenshotOptions", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00200a0000000015, 1, nullptr, STRUCT_OFFSET(AScreenshotFunctionalTestBase, ScreenshotOptions), Z_Construct_UScriptStruct_FAutomationScreenshotOptions, METADATA_PARAMS(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotOptions_MetaData, ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotOptions_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotCamera = { UE4CodeGen_Private::EPropertyClass::Object, "ScreenshotCamera", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x002008000008001d, 1, nullptr, STRUCT_OFFSET(AScreenshotFunctionalTestBase, ScreenshotCamera), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotCamera_MetaData, ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotCamera_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_Notes = { UE4CodeGen_Private::EPropertyClass::Str, "Notes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000015, 1, nullptr, STRUCT_OFFSET(AScreenshotFunctionalTestBase, Notes), METADATA_PARAMS(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_Notes_MetaData, ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_Notes_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::ClassParams = {
		...
		0x009000A1u,
		nullptr, 0,
		Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(AScreenshotFunctionalTestBase, 2123361239);
