...
// End Cross Module References
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMediaSource_GetUrl_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Str, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(MediaSource_eventGetUrl_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaSource_GetUrl_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaSource, "GetUrl", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x54020400, sizeof(MediaSource_eventGetUrl_Parms), Z_Construct_UFunction_UMediaSource_GetUrl_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UMediaSource_GetUrl_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMediaSource_GetUrl_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UMediaSource_GetUrl_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaSource_Validate_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Bool, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(MediaSource_eventValidate_Parms), &Z_Construct_UFunction_UMediaSource_Validate_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaSource_Validate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaSource, "Validate", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x54020400, sizeof(MediaSource_eventValidate_Parms), Z_Construct_UFunction_UMediaSource_Validate_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UMediaSource_Validate_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMediaSource_Validate_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UMediaSource_Validate_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMediaSource_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMediaSource_GetUrl, "GetUrl" }, // 1521672634
		{ &Z_Construct_UFunction_UMediaSource_Validate, "Validate" }, // 616387202
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMediaSource, 290456230);
