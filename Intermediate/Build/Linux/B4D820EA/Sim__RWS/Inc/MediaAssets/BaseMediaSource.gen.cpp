...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlayerName = { UE4CodeGen_Private::EPropertyClass::Name, "PlayerName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000002000, 1, nullptr, STRUCT_OFFSET(UBaseMediaSource, PlayerName), METADATA_PARAMS(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlayerName_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlayerName_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames = { UE4CodeGen_Private::EPropertyClass::Map, "PlatformPlayerNames", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000800002005, 1, nullptr, STRUCT_OFFSET(UBaseMediaSource, PlatformPlayerNames), METADATA_PARAMS(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_MetaData)) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_Key_KeyProp = { UE4CodeGen_Private::EPropertyClass::Str, "PlatformPlayerNames_Key", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000800000001, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_ValueProp = { UE4CodeGen_Private::EPropertyClass::Name, "PlatformPlayerNames", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000800000001, 1, nullptr, 1, METADATA_PARAMS(nullptr, 0) };
#endif // WITH_EDITORONLY_DATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBaseMediaSource_Statics::ClassParams = {
		...
		0x001010A1u,
		nullptr, 0,
		Z_Construct_UClass_UBaseMediaSource_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UBaseMediaSource_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UBaseMediaSource, 4049497092);
