...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFSlateSound
{
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FSlateSound_Statics::NewProp_ResourceObject = { UE4CodeGen_Private::EPropertyClass::Object, "ResourceObject", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000005, 1, nullptr, STRUCT_OFFSET(FSlateSound, ResourceObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSlateSound_Statics::NewProp_ResourceObject_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSlateSound_Statics::NewProp_ResourceObject_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSlateSound_Statics::ReturnStructParams = {
		...
		sizeof(FSlateSound),
		alignof(FSlateSound),
		Z_Construct_UScriptStruct_FSlateSound_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FSlateSound_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FSlateSound_CRC() { return 807609714U; }
