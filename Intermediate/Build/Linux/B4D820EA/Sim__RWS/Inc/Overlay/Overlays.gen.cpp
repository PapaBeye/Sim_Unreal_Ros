...
static struct FScriptStruct_Overlay_StaticRegisterNativesFOverlayItem
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Position = { UE4CodeGen_Private::EPropertyClass::Struct, "Position", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FOverlayItem, Position), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Position_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Position_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Text = { UE4CodeGen_Private::EPropertyClass::Str, "Text", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FOverlayItem, Text), METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Text_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Text_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_EndTime = { UE4CodeGen_Private::EPropertyClass::Struct, "EndTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FOverlayItem, EndTime), Z_Construct_UScriptStruct_FTimespan, METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_EndTime_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_EndTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_StartTime = { UE4CodeGen_Private::EPropertyClass::Struct, "StartTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FOverlayItem, StartTime), Z_Construct_UScriptStruct_FTimespan, METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_StartTime_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_StartTime_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOverlayItem_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FOverlayItem_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FOverlayItem_CRC() { return 1171994959U; }
	...
	IMPLEMENT_CLASS(UOverlays, 2621517789);
