...
// End Cross Module References
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UScrollBar_SetState_Statics::NewProp_InThumbSizeFraction = { UE4CodeGen_Private::EPropertyClass::Float, "InThumbSizeFraction", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(ScrollBar_eventSetState_Parms, InThumbSizeFraction), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UScrollBar_SetState_Statics::NewProp_InOffsetFraction = { UE4CodeGen_Private::EPropertyClass::Float, "InOffsetFraction", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(ScrollBar_eventSetState_Parms, InOffsetFraction), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UScrollBar_SetState_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UScrollBar, "SetState", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(ScrollBar_eventSetState_Parms), Z_Construct_UFunction_UScrollBar_SetState_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UScrollBar_SetState_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UScrollBar_SetState_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UScrollBar_SetState_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UScrollBar_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UScrollBar_SetState, "SetState" }, // 2093807564
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UScrollBar_Statics::NewProp_Thickness = { UE4CodeGen_Private::EPropertyClass::Struct, "Thickness", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UScrollBar, Thickness), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_UScrollBar_Statics::NewProp_Thickness_MetaData, ARRAY_COUNT(Z_Construct_UClass_UScrollBar_Statics::NewProp_Thickness_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UScrollBar_Statics::NewProp_Orientation = { UE4CodeGen_Private::EPropertyClass::Byte, "Orientation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UScrollBar, Orientation), Z_Construct_UEnum_SlateCore_EOrientation, METADATA_PARAMS(Z_Construct_UClass_UScrollBar_Statics::NewProp_Orientation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UScrollBar_Statics::NewProp_Orientation_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UScrollBar_Statics::NewProp_bAlwaysShowScrollbar = { UE4CodeGen_Private::EPropertyClass::Bool, "bAlwaysShowScrollbar", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UScrollBar), &Z_Construct_UClass_UScrollBar_Statics::NewProp_bAlwaysShowScrollbar_SetBit, METADATA_PARAMS(Z_Construct_UClass_UScrollBar_Statics::NewProp_bAlwaysShowScrollbar_MetaData, ARRAY_COUNT(Z_Construct_UClass_UScrollBar_Statics::NewProp_bAlwaysShowScrollbar_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UScrollBar_Statics::NewProp_Style_MetaData[] = {
		{ "ModuleRelativePath", "Public/Components/ScrollBar.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UScrollBar_Statics::NewProp_Style = { UE4CodeGen_Private::EPropertyClass::Object, "Style", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000020000000, 1, nullptr, STRUCT_OFFSET(UScrollBar, Style_DEPRECATED), Z_Construct_UClass_USlateWidgetStyleAsset_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UScrollBar_Statics::NewProp_Style_MetaData, ARRAY_COUNT(Z_Construct_UClass_UScrollBar_Statics::NewProp_Style_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UScrollBar_Statics::NewProp_WidgetStyle = { UE4CodeGen_Private::EPropertyClass::Struct, "WidgetStyle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UScrollBar, WidgetStyle), Z_Construct_UScriptStruct_FScrollBarStyle, METADATA_PARAMS(Z_Construct_UClass_UScrollBar_Statics::NewProp_WidgetStyle_MetaData, ARRAY_COUNT(Z_Construct_UClass_UScrollBar_Statics::NewProp_WidgetStyle_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UScrollBar_Statics::ClassParams = {
		...
		Z_Construct_UClass_UScrollBar_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UScrollBar_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UScrollBar, 4176173106);
