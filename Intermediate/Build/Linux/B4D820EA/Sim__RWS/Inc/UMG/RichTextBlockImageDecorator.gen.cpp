...
class UScriptStruct* FRichImageRow::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern UMG_API uint32 Get_Z_Construct_UScriptStruct_FRichImageRow_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FRichImageRow, Z_Construct_UPackage__Script_UMG(), TEXT("RichImageRow"), sizeof(FRichImageRow), Get_Z_Construct_UScriptStruct_FRichImageRow_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_UMG_StaticRegisterNativesFRichImageRow
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRichImageRow_Statics::NewProp_Brush = { UE4CodeGen_Private::EPropertyClass::Struct, "Brush", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FRichImageRow, Brush), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(Z_Construct_UScriptStruct_FRichImageRow_Statics::NewProp_Brush_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FRichImageRow_Statics::NewProp_Brush_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRichImageRow_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FRichImageRow_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FRichImageRow_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FRichImageRow_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_UMG();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("RichImageRow"), sizeof(FRichImageRow), Get_Z_Construct_UScriptStruct_FRichImageRow_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FRichImageRow_CRC() { return 3464500492U; }
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_URichTextBlockImageDecorator_Statics::NewProp_ImageSet = { UE4CodeGen_Private::EPropertyClass::Object, "ImageSet", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000001, 1, nullptr, STRUCT_OFFSET(URichTextBlockImageDecorator, ImageSet), Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(Z_Construct_UClass_URichTextBlockImageDecorator_Statics::NewProp_ImageSet_MetaData, ARRAY_COUNT(Z_Construct_UClass_URichTextBlockImageDecorator_Statics::NewProp_ImageSet_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_URichTextBlockImageDecorator_Statics::ClassParams = {
		...
		0x001000A1u,
		nullptr, 0,
		Z_Construct_UClass_URichTextBlockImageDecorator_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_URichTextBlockImageDecorator_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(URichTextBlockImageDecorator, 3353308843);
