...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UMouseCursorBinding_GetValue_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Byte, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(MouseCursorBinding_eventGetValue_Parms, ReturnValue), Z_Construct_UEnum_CoreUObject_EMouseCursor, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UMouseCursorBinding_GetValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMouseCursorBinding, "GetValue", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x40020401, sizeof(MouseCursorBinding_eventGetValue_Parms), Z_Construct_UFunction_UMouseCursorBinding_GetValue_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UMouseCursorBinding_GetValue_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMouseCursorBinding_GetValue_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UMouseCursorBinding_GetValue_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMouseCursorBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMouseCursorBinding_GetValue, "GetValue" }, // 2895186464
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMouseCursorBinding, 2519005625);
