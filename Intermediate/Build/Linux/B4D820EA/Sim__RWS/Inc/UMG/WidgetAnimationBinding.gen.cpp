...
static struct FScriptStruct_UMG_StaticRegisterNativesFWidgetAnimationBinding
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_bIsRootWidget = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsRootWidget", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FWidgetAnimationBinding), &Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_bIsRootWidget_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_bIsRootWidget_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_bIsRootWidget_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_WidgetName = { UE4CodeGen_Private::EPropertyClass::Name, "WidgetName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FWidgetAnimationBinding, WidgetName), METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_WidgetName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_WidgetName_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FWidgetAnimationBinding_CRC() { return 784949997U; }
