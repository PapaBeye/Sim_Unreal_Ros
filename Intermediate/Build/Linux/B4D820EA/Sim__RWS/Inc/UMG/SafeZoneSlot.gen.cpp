...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_VAlign = { UE4CodeGen_Private::EPropertyClass::Byte, "VAlign", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(USafeZoneSlot, VAlign), Z_Construct_UEnum_SlateCore_EVerticalAlignment, METADATA_PARAMS(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_VAlign_MetaData, ARRAY_COUNT(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_VAlign_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_HAlign = { UE4CodeGen_Private::EPropertyClass::Byte, "HAlign", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(USafeZoneSlot, HAlign), Z_Construct_UEnum_SlateCore_EHorizontalAlignment, METADATA_PARAMS(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_HAlign_MetaData, ARRAY_COUNT(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_HAlign_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_SafeAreaScale = { UE4CodeGen_Private::EPropertyClass::Struct, "SafeAreaScale", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(USafeZoneSlot, SafeAreaScale), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_SafeAreaScale_MetaData, ARRAY_COUNT(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_SafeAreaScale_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_bIsTitleSafe = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsTitleSafe", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(USafeZoneSlot), &Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_bIsTitleSafe_SetBit, METADATA_PARAMS(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_bIsTitleSafe_MetaData, ARRAY_COUNT(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_bIsTitleSafe_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USafeZoneSlot_Statics::ClassParams = {
		...
		0x00A000A0u,
		nullptr, 0,
		Z_Construct_UClass_USafeZoneSlot_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USafeZoneSlot_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(USafeZoneSlot, 303688716);
