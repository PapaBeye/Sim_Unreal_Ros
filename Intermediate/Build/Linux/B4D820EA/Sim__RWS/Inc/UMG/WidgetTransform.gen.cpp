...
static struct FScriptStruct_UMG_StaticRegisterNativesFWidgetTransform
{
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Angle = { UE4CodeGen_Private::EPropertyClass::Float, "Angle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FWidgetTransform, Angle), METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Angle_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Angle_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWidgetTransform_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FWidgetTransform_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetTransform_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FWidgetTransform_CRC() { return 2322457107U; }
