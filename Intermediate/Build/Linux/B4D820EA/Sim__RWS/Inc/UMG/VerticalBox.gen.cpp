...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVerticalBox_AddChildToVerticalBox_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Object, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000080588, 1, nullptr, STRUCT_OFFSET(VerticalBox_eventAddChildToVerticalBox_Parms, ReturnValue), Z_Construct_UClass_UVerticalBoxSlot_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UVerticalBox_AddChildToVerticalBox_Statics::NewProp_ReturnValue_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UVerticalBox_AddChildToVerticalBox_Statics::NewProp_ReturnValue_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UVerticalBox_AddChildToVerticalBox_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVerticalBox, "AddChildToVerticalBox", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(VerticalBox_eventAddChildToVerticalBox_Parms), Z_Construct_UFunction_UVerticalBox_AddChildToVerticalBox_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UVerticalBox_AddChildToVerticalBox_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UVerticalBox_AddChildToVerticalBox_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UVerticalBox_AddChildToVerticalBox_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVerticalBox_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVerticalBox_AddChildToVerticalBox, "AddChildToVerticalBox" }, // 737583400
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UVerticalBox, 1877842386);
