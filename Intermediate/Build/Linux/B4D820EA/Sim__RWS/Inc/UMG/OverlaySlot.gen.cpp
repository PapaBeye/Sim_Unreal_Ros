...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOverlaySlot, "SetHorizontalAlignment", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(OverlaySlot_eventSetHorizontalAlignment_Parms), Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::NewProp_InPadding = { UE4CodeGen_Private::EPropertyClass::Struct, "InPadding", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(OverlaySlot_eventSetPadding_Parms, InPadding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOverlaySlot, "SetPadding", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(OverlaySlot_eventSetPadding_Parms), Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOverlaySlot, "SetVerticalAlignment", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(OverlaySlot_eventSetVerticalAlignment_Parms), Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOverlaySlot_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment, "SetHorizontalAlignment" }, // 3945815968
		{ &Z_Construct_UFunction_UOverlaySlot_SetPadding, "SetPadding" }, // 2790643323
		{ &Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment, "SetVerticalAlignment" }, // 4043257633
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOverlaySlot_Statics::NewProp_Padding = { UE4CodeGen_Private::EPropertyClass::Struct, "Padding", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UOverlaySlot, Padding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(Z_Construct_UClass_UOverlaySlot_Statics::NewProp_Padding_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOverlaySlot_Statics::NewProp_Padding_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOverlaySlot_Statics::ClassParams = {
		...
		Z_Construct_UClass_UOverlaySlot_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UOverlaySlot_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UOverlaySlot, 256694820);
