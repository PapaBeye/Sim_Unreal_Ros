...
static struct FScriptStruct_UMG_StaticRegisterNativesFMovieSceneWidgetMaterialSectionTemplate
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneWidgetMaterialSectionTemplate_Statics::NewProp_BrushPropertyNamePath = { UE4CodeGen_Private::EPropertyClass::Array, "BrushPropertyNamePath", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneWidgetMaterialSectionTemplate, BrushPropertyNamePath), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneWidgetMaterialSectionTemplate_Statics::NewProp_BrushPropertyNamePath_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneWidgetMaterialSectionTemplate_Statics::NewProp_BrushPropertyNamePath_MetaData)) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieSceneWidgetMaterialSectionTemplate_Statics::NewProp_BrushPropertyNamePath_Inner = { UE4CodeGen_Private::EPropertyClass::Name, "BrushPropertyNamePath", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneWidgetMaterialSectionTemplate_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneWidgetMaterialSectionTemplate_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneWidgetMaterialSectionTemplate_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneWidgetMaterialSectionTemplate_CRC() { return 1339449105U; }
