...
static struct FScriptStruct_UMG_StaticRegisterNativesFMovieSceneMarginSectionTemplate
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::NewProp_BottomCurve = { UE4CodeGen_Private::EPropertyClass::Struct, "BottomCurve", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneMarginSectionTemplate, BottomCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::NewProp_BottomCurve_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::NewProp_BottomCurve_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::NewProp_RightCurve = { UE4CodeGen_Private::EPropertyClass::Struct, "RightCurve", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneMarginSectionTemplate, RightCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::NewProp_RightCurve_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::NewProp_RightCurve_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::NewProp_TopCurve = { UE4CodeGen_Private::EPropertyClass::Struct, "TopCurve", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneMarginSectionTemplate, TopCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::NewProp_TopCurve_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::NewProp_TopCurve_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneMarginSectionTemplate_CRC() { return 2972279705U; }
