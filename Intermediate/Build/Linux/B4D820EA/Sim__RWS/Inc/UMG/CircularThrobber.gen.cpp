...
// End Cross Module References
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UCircularThrobber_SetNumberOfPieces_Statics::NewProp_InNumberOfPieces = { UE4CodeGen_Private::EPropertyClass::Int, "InNumberOfPieces", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(CircularThrobber_eventSetNumberOfPieces_Parms, InNumberOfPieces), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCircularThrobber_SetNumberOfPieces_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCircularThrobber, "SetNumberOfPieces", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(CircularThrobber_eventSetNumberOfPieces_Parms), Z_Construct_UFunction_UCircularThrobber_SetNumberOfPieces_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCircularThrobber_SetNumberOfPieces_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCircularThrobber_SetNumberOfPieces_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCircularThrobber_SetNumberOfPieces_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCircularThrobber_SetPeriod_Statics::NewProp_InPeriod = { UE4CodeGen_Private::EPropertyClass::Float, "InPeriod", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(CircularThrobber_eventSetPeriod_Parms, InPeriod), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCircularThrobber_SetRadius_Statics::NewProp_InRadius = { UE4CodeGen_Private::EPropertyClass::Float, "InRadius", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(CircularThrobber_eventSetRadius_Parms, InRadius), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCircularThrobber_SetRadius_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCircularThrobber, "SetRadius", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(CircularThrobber_eventSetRadius_Parms), Z_Construct_UFunction_UCircularThrobber_SetRadius_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCircularThrobber_SetRadius_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCircularThrobber_SetRadius_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCircularThrobber_SetRadius_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCircularThrobber_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCircularThrobber_SetNumberOfPieces, "SetNumberOfPieces" }, // 1478496295
		{ &Z_Construct_UFunction_UCircularThrobber_SetPeriod, "SetPeriod" }, // 2696465942
		{ &Z_Construct_UFunction_UCircularThrobber_SetRadius, "SetRadius" }, // 2649125689
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCircularThrobber_Statics::NewProp_PieceImage = { UE4CodeGen_Private::EPropertyClass::Object, "PieceImage", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000020000000, 1, nullptr, STRUCT_OFFSET(UCircularThrobber, PieceImage_DEPRECATED), Z_Construct_UClass_USlateBrushAsset_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_PieceImage_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_PieceImage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCircularThrobber_Statics::NewProp_Radius = { UE4CodeGen_Private::EPropertyClass::Float, "Radius", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UCircularThrobber, Radius), METADATA_PARAMS(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_Radius_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_Radius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCircularThrobber_Statics::NewProp_Period = { UE4CodeGen_Private::EPropertyClass::Float, "Period", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UCircularThrobber, Period), METADATA_PARAMS(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_Period_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_Period_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UCircularThrobber_Statics::NewProp_NumberOfPieces = { UE4CodeGen_Private::EPropertyClass::Int, "NumberOfPieces", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UCircularThrobber, NumberOfPieces), METADATA_PARAMS(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_NumberOfPieces_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_NumberOfPieces_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UCircularThrobber_Statics::ClassParams = {
		...
		Z_Construct_UClass_UCircularThrobber_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UCircularThrobber_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UCircularThrobber, 630299441);
