...
// End Cross Module References
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotHeight_Statics::NewProp_InMinDesiredSlotHeight = { UE4CodeGen_Private::EPropertyClass::Float, "InMinDesiredSlotHeight", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(UniformGridPanel_eventSetMinDesiredSlotHeight_Parms, InMinDesiredSlotHeight), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotHeight_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUniformGridPanel, "SetMinDesiredSlotHeight", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(UniformGridPanel_eventSetMinDesiredSlotHeight_Parms), Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotHeight_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotHeight_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotHeight_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotHeight_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotWidth_Statics::NewProp_InMinDesiredSlotWidth = { UE4CodeGen_Private::EPropertyClass::Float, "InMinDesiredSlotWidth", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(UniformGridPanel_eventSetMinDesiredSlotWidth_Parms, InMinDesiredSlotWidth), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotWidth_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUniformGridPanel, "SetMinDesiredSlotWidth", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(UniformGridPanel_eventSetMinDesiredSlotWidth_Parms), Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotWidth_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotWidth_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotWidth_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotWidth_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUniformGridPanel_SetSlotPadding_Statics::NewProp_InSlotPadding = { UE4CodeGen_Private::EPropertyClass::Struct, "InSlotPadding", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(UniformGridPanel_eventSetSlotPadding_Parms, InSlotPadding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UUniformGridPanel_SetSlotPadding_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUniformGridPanel, "SetSlotPadding", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(UniformGridPanel_eventSetSlotPadding_Parms), Z_Construct_UFunction_UUniformGridPanel_SetSlotPadding_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UUniformGridPanel_SetSlotPadding_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UUniformGridPanel_SetSlotPadding_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UUniformGridPanel_SetSlotPadding_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UUniformGridPanel_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUniformGridPanel_AddChildToUniformGrid, "AddChildToUniformGrid" }, // 2965444024
		{ &Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotHeight, "SetMinDesiredSlotHeight" }, // 295198877
		{ &Z_Construct_UFunction_UUniformGridPanel_SetMinDesiredSlotWidth, "SetMinDesiredSlotWidth" }, // 317607704
		{ &Z_Construct_UFunction_UUniformGridPanel_SetSlotPadding, "SetSlotPadding" }, // 2883569627
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UUniformGridPanel_Statics::NewProp_MinDesiredSlotWidth = { UE4CodeGen_Private::EPropertyClass::Float, "MinDesiredSlotWidth", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UUniformGridPanel, MinDesiredSlotWidth), METADATA_PARAMS(Z_Construct_UClass_UUniformGridPanel_Statics::NewProp_MinDesiredSlotWidth_MetaData, ARRAY_COUNT(Z_Construct_UClass_UUniformGridPanel_Statics::NewProp_MinDesiredSlotWidth_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUniformGridPanel_Statics::NewProp_SlotPadding = { UE4CodeGen_Private::EPropertyClass::Struct, "SlotPadding", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UUniformGridPanel, SlotPadding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(Z_Construct_UClass_UUniformGridPanel_Statics::NewProp_SlotPadding_MetaData, ARRAY_COUNT(Z_Construct_UClass_UUniformGridPanel_Statics::NewProp_SlotPadding_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UUniformGridPanel_Statics::ClassParams = {
		...
		Z_Construct_UClass_UUniformGridPanel_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UUniformGridPanel_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UUniformGridPanel, 4080864756);
