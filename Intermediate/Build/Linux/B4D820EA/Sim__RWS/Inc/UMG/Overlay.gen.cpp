...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Object, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000080588, 1, nullptr, STRUCT_OFFSET(Overlay_eventAddChildToOverlay_Parms, ReturnValue), Z_Construct_UClass_UOverlaySlot_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::NewProp_ReturnValue_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::NewProp_ReturnValue_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::NewProp_Content = { UE4CodeGen_Private::EPropertyClass::Object, "Content", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000080080, 1, nullptr, STRUCT_OFFSET(Overlay_eventAddChildToOverlay_Parms, Content), Z_Construct_UClass_UWidget_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::NewProp_Content_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::NewProp_Content_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOverlay, "AddChildToOverlay", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(Overlay_eventAddChildToOverlay_Parms), Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOverlay_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOverlay_AddChildToOverlay, "AddChildToOverlay" }, // 3982015145
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UOverlay, 3813321644);
