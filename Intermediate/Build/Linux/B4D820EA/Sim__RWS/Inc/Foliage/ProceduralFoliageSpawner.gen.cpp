...
// End Cross Module References
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate_Statics::NewProp_NumSteps = { UE4CodeGen_Private::EPropertyClass::Int, "NumSteps", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(ProceduralFoliageSpawner_eventSimulate_Parms, NumSteps), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UProceduralFoliageSpawner, "Simulate", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(ProceduralFoliageSpawner_eventSimulate_Parms), Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UProceduralFoliageSpawner_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate, "Simulate" }, // 1899602305
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_bNeedsSimulation = { UE4CodeGen_Private::EPropertyClass::Bool, "bNeedsSimulation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UProceduralFoliageSpawner), &Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_bNeedsSimulation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_bNeedsSimulation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_bNeedsSimulation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_FoliageTypes = { UE4CodeGen_Private::EPropertyClass::Array, "FoliageTypes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000001, 1, nullptr, STRUCT_OFFSET(UProceduralFoliageSpawner, FoliageTypes), METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_FoliageTypes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_FoliageTypes_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_FoliageTypes_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "FoliageTypes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FFoliageTypeObject, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_MinimumQuadTreeSize = { UE4CodeGen_Private::EPropertyClass::Float, "MinimumQuadTreeSize", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UProceduralFoliageSpawner, MinimumQuadTreeSize), METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_MinimumQuadTreeSize_MetaData, ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_MinimumQuadTreeSize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_NumUniqueTiles = { UE4CodeGen_Private::EPropertyClass::Int, "NumUniqueTiles", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UProceduralFoliageSpawner, NumUniqueTiles), METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_NumUniqueTiles_MetaData, ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_NumUniqueTiles_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_TileSize = { UE4CodeGen_Private::EPropertyClass::Float, "TileSize", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UProceduralFoliageSpawner, TileSize), METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_TileSize_MetaData, ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_TileSize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_RandomSeed = { UE4CodeGen_Private::EPropertyClass::Int, "RandomSeed", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UProceduralFoliageSpawner, RandomSeed), METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_RandomSeed_MetaData, ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_RandomSeed_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::ClassParams = {
		...
		Z_Construct_UClass_UProceduralFoliageSpawner_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UProceduralFoliageSpawner, 2342818061);
