...
class UScriptStruct* FNavGraphNode::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern NAVIGATIONSYSTEM_API uint32 Get_Z_Construct_UScriptStruct_FNavGraphNode_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FNavGraphNode, Z_Construct_UPackage__Script_NavigationSystem(), TEXT("NavGraphNode"), sizeof(FNavGraphNode), Get_Z_Construct_UScriptStruct_FNavGraphNode_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_NavigationSystem_StaticRegisterNativesFNavGraphNode
{
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewProp_Owner = { UE4CodeGen_Private::EPropertyClass::Object, "Owner", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FNavGraphNode, Owner), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewProp_Owner_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewProp_Owner_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNavGraphNode_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FNavGraphNode_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FNavGraphNode_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FNavGraphNode_CRC() { return 1305641571U; }
class UScriptStruct* FNavGraphEdge::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern NAVIGATIONSYSTEM_API uint32 Get_Z_Construct_UScriptStruct_FNavGraphEdge_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FNavGraphEdge, Z_Construct_UPackage__Script_NavigationSystem(), TEXT("NavGraphEdge"), sizeof(FNavGraphEdge), Get_Z_Construct_UScriptStruct_FNavGraphEdge_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_NavigationSystem_StaticRegisterNativesFNavGraphEdge
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FNavGraphEdge_CRC() { return 3530727482U; }
	...
	IMPLEMENT_CLASS(ANavigationGraph, 2762164987);
