...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNavRelevantComponent_SetNavigationRelevancy_Statics::NewProp_bRelevant = { UE4CodeGen_Private::EPropertyClass::Bool, "bRelevant", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(NavRelevantComponent_eventSetNavigationRelevancy_Parms), &Z_Construct_UFunction_UNavRelevantComponent_SetNavigationRelevancy_Statics::NewProp_bRelevant_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UNavRelevantComponent_SetNavigationRelevancy_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNavRelevantComponent, "SetNavigationRelevancy", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(NavRelevantComponent_eventSetNavigationRelevancy_Parms), Z_Construct_UFunction_UNavRelevantComponent_SetNavigationRelevancy_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UNavRelevantComponent_SetNavigationRelevancy_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UNavRelevantComponent_SetNavigationRelevancy_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UNavRelevantComponent_SetNavigationRelevancy_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNavRelevantComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNavRelevantComponent_SetNavigationRelevancy, "SetNavigationRelevancy" }, // 557952186
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNavRelevantComponent_Statics::NewProp_bAttachToOwnersRoot = { UE4CodeGen_Private::EPropertyClass::Bool, "bAttachToOwnersRoot", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UNavRelevantComponent), &Z_Construct_UClass_UNavRelevantComponent_Statics::NewProp_bAttachToOwnersRoot_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNavRelevantComponent_Statics::NewProp_bAttachToOwnersRoot_MetaData, ARRAY_COUNT(Z_Construct_UClass_UNavRelevantComponent_Statics::NewProp_bAttachToOwnersRoot_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UNavRelevantComponent_Statics::ClassParams = {
		...
		Z_Construct_UClass_UNavRelevantComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UNavRelevantComponent_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UNavRelevantComponent, 1669754796);
