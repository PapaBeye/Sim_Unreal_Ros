...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bUseExtremes = { UE4CodeGen_Private::EPropertyClass::Bool, "bUseExtremes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UDistributionVectorUniform), &Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bUseExtremes_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bUseExtremes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bUseExtremes_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_LockedAxes = { UE4CodeGen_Private::EPropertyClass::Byte, "LockedAxes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UDistributionVectorUniform, LockedAxes), Z_Construct_UEnum_Engine_EDistributionVectorLockFlags, METADATA_PARAMS(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_LockedAxes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_LockedAxes_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bLockAxes = { UE4CodeGen_Private::EPropertyClass::Bool, "bLockAxes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UDistributionVectorUniform), &Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bLockAxes_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bLockAxes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bLockAxes_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_Min = { UE4CodeGen_Private::EPropertyClass::Struct, "Min", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UDistributionVectorUniform, Min), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_Min_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_Min_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_Max = { UE4CodeGen_Private::EPropertyClass::Struct, "Max", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UDistributionVectorUniform, Max), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_Max_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_Max_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDistributionVectorUniform_Statics::ClassParams = {
		...
		0x003030A0u,
		nullptr, 0,
		Z_Construct_UClass_UDistributionVectorUniform_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UDistributionVectorUniform_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UDistributionVectorUniform, 1780545943);
