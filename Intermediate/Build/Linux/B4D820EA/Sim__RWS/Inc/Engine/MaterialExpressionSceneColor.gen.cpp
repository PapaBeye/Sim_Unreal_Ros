...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMaterialSceneAttributeInputMode_CRC() { return 716679031U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_ConstInput = { UE4CodeGen_Private::EPropertyClass::Struct, "ConstInput", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionSceneColor, ConstInput), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_ConstInput_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_ConstInput_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_OffsetFraction = { UE4CodeGen_Private::EPropertyClass::Struct, "OffsetFraction", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000020000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionSceneColor, OffsetFraction_DEPRECATED), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_OffsetFraction_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_OffsetFraction_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_Input = { UE4CodeGen_Private::EPropertyClass::Struct, "Input", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionSceneColor, Input), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_Input_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_Input_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_InputMode = { UE4CodeGen_Private::EPropertyClass::Byte, "InputMode", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionSceneColor, InputMode), Z_Construct_UEnum_Engine_EMaterialSceneAttributeInputMode, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_InputMode_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::NewProp_InputMode_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::ClassParams = {
		...
		0x000020A0u,
		nullptr, 0,
		Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSceneColor_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMaterialExpressionSceneColor, 4055051458);
