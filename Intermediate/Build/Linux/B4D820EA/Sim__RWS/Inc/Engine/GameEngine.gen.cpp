...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGameEngine_Statics::NewProp_GameInstance = { UE4CodeGen_Private::EPropertyClass::Object, "GameInstance", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000002000, 1, nullptr, STRUCT_OFFSET(UGameEngine, GameInstance), Z_Construct_UClass_UGameInstance_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGameEngine_Statics::NewProp_GameInstance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGameEngine_Statics::NewProp_GameInstance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGameEngine_Statics::NewProp_ServerFlushLogInterval = { UE4CodeGen_Private::EPropertyClass::Float, "ServerFlushLogInterval", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, STRUCT_OFFSET(UGameEngine, ServerFlushLogInterval), METADATA_PARAMS(Z_Construct_UClass_UGameEngine_Statics::NewProp_ServerFlushLogInterval_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGameEngine_Statics::NewProp_ServerFlushLogInterval_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGameEngine_Statics::NewProp_MaxDeltaTime = { UE4CodeGen_Private::EPropertyClass::Float, "MaxDeltaTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, STRUCT_OFFSET(UGameEngine, MaxDeltaTime), METADATA_PARAMS(Z_Construct_UClass_UGameEngine_Statics::NewProp_MaxDeltaTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGameEngine_Statics::NewProp_MaxDeltaTime_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGameEngine_Statics::ClassParams = {
		...
		0x001000AEu,
		nullptr, 0,
		Z_Construct_UClass_UGameEngine_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UGameEngine_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UGameEngine, 3259701761);
