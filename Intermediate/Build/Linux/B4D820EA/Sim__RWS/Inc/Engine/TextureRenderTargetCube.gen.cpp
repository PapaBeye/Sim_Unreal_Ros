...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_bForceLinearGamma = { UE4CodeGen_Private::EPropertyClass::Bool, "bForceLinearGamma", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UTextureRenderTargetCube), &Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_bForceLinearGamma_SetBit, METADATA_PARAMS(Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_bForceLinearGamma_MetaData, ARRAY_COUNT(Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_bForceLinearGamma_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_bHDR = { UE4CodeGen_Private::EPropertyClass::Bool, "bHDR", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010010000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UTextureRenderTargetCube), &Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_bHDR_SetBit, METADATA_PARAMS(Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_bHDR_MetaData, ARRAY_COUNT(Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_bHDR_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_OverrideFormat = { UE4CodeGen_Private::EPropertyClass::Byte, "OverrideFormat", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UTextureRenderTargetCube, OverrideFormat), Z_Construct_UEnum_CoreUObject_EPixelFormat, METADATA_PARAMS(Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_OverrideFormat_MetaData, ARRAY_COUNT(Z_Construct_UClass_UTextureRenderTargetCube_Statics::NewProp_OverrideFormat_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UTextureRenderTargetCube_Statics::ClassParams = {
		...
		0x008800A0u,
		nullptr, 0,
		Z_Construct_UClass_UTextureRenderTargetCube_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UTextureRenderTargetCube_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UTextureRenderTargetCube, 1428318156);
