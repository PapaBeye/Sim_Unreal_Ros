...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionVertexInterpolator_Statics::NewProp_Input = { UE4CodeGen_Private::EPropertyClass::Struct, "Input", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionVertexInterpolator, Input), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionVertexInterpolator_Statics::NewProp_Input_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionVertexInterpolator_Statics::NewProp_Input_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionVertexInterpolator_Statics::ClassParams = {
		...
		0x000020A0u,
		nullptr, 0,
		Z_Construct_UClass_UMaterialExpressionVertexInterpolator_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionVertexInterpolator_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMaterialExpressionVertexInterpolator, 225749778);
