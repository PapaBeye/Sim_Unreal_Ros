...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyZ = { UE4CodeGen_Private::EPropertyClass::Bool, "MultiplyZ", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleSizeMultiplyLife), &Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyZ_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyZ_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyZ_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyY = { UE4CodeGen_Private::EPropertyClass::Bool, "MultiplyY", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleSizeMultiplyLife), &Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyY_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyY_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyY_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyX = { UE4CodeGen_Private::EPropertyClass::Bool, "MultiplyX", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleSizeMultiplyLife), &Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyX_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyX_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_MultiplyX_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_LifeMultiplier = { UE4CodeGen_Private::EPropertyClass::Struct, "LifeMultiplier", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleSizeMultiplyLife, LifeMultiplier), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_LifeMultiplier_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::NewProp_LifeMultiplier_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::ClassParams = {
		...
		0x008810A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSizeMultiplyLife_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleSizeMultiplyLife, 1097608187);
