...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArrayMemory = { UE4CodeGen_Private::EPropertyClass::Int, "MaxRepArrayMemory", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004001, 1, nullptr, STRUCT_OFFSET(UNetworkSettings, MaxRepArrayMemory), METADATA_PARAMS(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArrayMemory_MetaData, ARRAY_COUNT(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArrayMemory_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArraySize = { UE4CodeGen_Private::EPropertyClass::Int, "MaxRepArraySize", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004001, 1, nullptr, STRUCT_OFFSET(UNetworkSettings, MaxRepArraySize), METADATA_PARAMS(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArraySize_MetaData, ARRAY_COUNT(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArraySize_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bEnableMultiplayerWorldOriginRebasing = { UE4CodeGen_Private::EPropertyClass::Bool, "bEnableMultiplayerWorldOriginRebasing", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UNetworkSettings), &Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bEnableMultiplayerWorldOriginRebasing_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bEnableMultiplayerWorldOriginRebasing_MetaData, ARRAY_COUNT(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bEnableMultiplayerWorldOriginRebasing_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bVerifyPeer = { UE4CodeGen_Private::EPropertyClass::Bool, "bVerifyPeer", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UNetworkSettings), &Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bVerifyPeer_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bVerifyPeer_MetaData, ARRAY_COUNT(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bVerifyPeer_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UNetworkSettings_Statics::ClassParams = {
		...
		0x001000A6u,
		nullptr, 0,
		Z_Construct_UClass_UNetworkSettings_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UNetworkSettings_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UNetworkSettings, 3156857771);
