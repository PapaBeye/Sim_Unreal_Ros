...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleLocationDirect_Statics::NewProp_Direction = { UE4CodeGen_Private::EPropertyClass::Struct, "Direction", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleLocationDirect, Direction), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationDirect_Statics::NewProp_Direction_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationDirect_Statics::NewProp_Direction_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleLocationDirect_Statics::NewProp_LocationOffset = { UE4CodeGen_Private::EPropertyClass::Struct, "LocationOffset", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleLocationDirect, LocationOffset), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationDirect_Statics::NewProp_LocationOffset_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationDirect_Statics::NewProp_LocationOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleLocationDirect_Statics::NewProp_Location = { UE4CodeGen_Private::EPropertyClass::Struct, "Location", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleLocationDirect, Location), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationDirect_Statics::NewProp_Location_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationDirect_Statics::NewProp_Location_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleLocationDirect_Statics::ClassParams = {
		...
		0x009010A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleLocationDirect_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationDirect_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleLocationDirect, 881407734);
