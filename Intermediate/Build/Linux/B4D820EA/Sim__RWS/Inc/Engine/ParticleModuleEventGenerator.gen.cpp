...
static struct FScriptStruct_Engine_StaticRegisterNativesFParticleEvent_GenerateInfo
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_ParticleModuleEventsToSendToGame = { UE4CodeGen_Private::EPropertyClass::Array, "ParticleModuleEventsToSendToGame", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000009, 1, nullptr, STRUCT_OFFSET(FParticleEvent_GenerateInfo, ParticleModuleEventsToSendToGame), METADATA_PARAMS(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_ParticleModuleEventsToSendToGame_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_ParticleModuleEventsToSendToGame_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_ParticleModuleEventsToSendToGame_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "ParticleModuleEventsToSendToGame", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0002000000080008, 1, nullptr, 0, Z_Construct_UClass_UParticleModuleEventSendToGame_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_ParticleModuleEventsToSendToGame_Inner_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_ParticleModuleEventsToSendToGame_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_CustomName = { UE4CodeGen_Private::EPropertyClass::Name, "CustomName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FParticleEvent_GenerateInfo, CustomName), METADATA_PARAMS(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_CustomName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_CustomName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_ParticleFrequency = { UE4CodeGen_Private::EPropertyClass::Int, "ParticleFrequency", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FParticleEvent_GenerateInfo, ParticleFrequency), METADATA_PARAMS(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_ParticleFrequency_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_ParticleFrequency_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_Frequency = { UE4CodeGen_Private::EPropertyClass::Int, "Frequency", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FParticleEvent_GenerateInfo, Frequency), METADATA_PARAMS(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_Frequency_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_Frequency_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_Type = { UE4CodeGen_Private::EPropertyClass::Byte, "Type", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FParticleEvent_GenerateInfo, Type), Z_Construct_UEnum_Engine_EParticleEventType, METADATA_PARAMS(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_Type_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::NewProp_Type_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FParticleEvent_GenerateInfo_CRC() { return 3331697406U; }
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleEventGenerator_Statics::ClassParams = {
		...
		0x008810A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleEventGenerator_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleEventGenerator_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleEventGenerator, 3383603819);
