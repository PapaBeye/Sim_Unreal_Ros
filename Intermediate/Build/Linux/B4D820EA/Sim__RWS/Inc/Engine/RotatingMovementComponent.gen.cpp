...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_bRotationInLocalSpace = { UE4CodeGen_Private::EPropertyClass::Bool, "bRotationInLocalSpace", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(URotatingMovementComponent), &Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_bRotationInLocalSpace_SetBit, METADATA_PARAMS(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_bRotationInLocalSpace_MetaData, ARRAY_COUNT(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_bRotationInLocalSpace_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_PivotTranslation = { UE4CodeGen_Private::EPropertyClass::Struct, "PivotTranslation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(URotatingMovementComponent, PivotTranslation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_PivotTranslation_MetaData, ARRAY_COUNT(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_PivotTranslation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_RotationRate = { UE4CodeGen_Private::EPropertyClass::Struct, "RotationRate", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(URotatingMovementComponent, RotationRate), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_RotationRate_MetaData, ARRAY_COUNT(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_RotationRate_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_URotatingMovementComponent_Statics::ClassParams = {
		...
		0x00B000A4u,
		nullptr, 0,
		Z_Construct_UClass_URotatingMovementComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_URotatingMovementComponent_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(URotatingMovementComponent, 3167266543);
