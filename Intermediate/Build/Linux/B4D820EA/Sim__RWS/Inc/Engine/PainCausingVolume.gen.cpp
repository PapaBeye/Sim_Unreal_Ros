...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_BACKUP_bPainCausing = { UE4CodeGen_Private::EPropertyClass::Bool, "BACKUP_bPainCausing", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(APainCausingVolume), &Z_Construct_UClass_APainCausingVolume_Statics::NewProp_BACKUP_bPainCausing_SetBit, METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_BACKUP_bPainCausing_MetaData, ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_BACKUP_bPainCausing_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bEntryPain = { UE4CodeGen_Private::EPropertyClass::Bool, "bEntryPain", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(APainCausingVolume), &Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bEntryPain_SetBit, METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bEntryPain_MetaData, ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bEntryPain_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_PainInterval = { UE4CodeGen_Private::EPropertyClass::Float, "PainInterval", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(APainCausingVolume, PainInterval), METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_PainInterval_MetaData, ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_PainInterval_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_DamageType = { UE4CodeGen_Private::EPropertyClass::Class, "DamageType", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0014000000000005, 1, nullptr, STRUCT_OFFSET(APainCausingVolume, DamageType), Z_Construct_UClass_UDamageType_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_DamageType_MetaData, ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_DamageType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_DamagePerSec = { UE4CodeGen_Private::EPropertyClass::Float, "DamagePerSec", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(APainCausingVolume, DamagePerSec), METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_DamagePerSec_MetaData, ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_DamagePerSec_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bPainCausing = { UE4CodeGen_Private::EPropertyClass::Bool, "bPainCausing", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(APainCausingVolume), &Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bPainCausing_SetBit, METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bPainCausing_MetaData, ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bPainCausing_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APainCausingVolume_Statics::ClassParams = {
		...
		0x009000A0u,
		nullptr, 0,
		Z_Construct_UClass_APainCausingVolume_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(APainCausingVolume, 1430981555);
