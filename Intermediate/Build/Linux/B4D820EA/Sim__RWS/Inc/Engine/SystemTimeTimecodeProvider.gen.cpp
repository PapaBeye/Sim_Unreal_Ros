...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USystemTimeTimecodeProvider_SetFrameRate_Statics::NewProp_InFrameRate = { UE4CodeGen_Private::EPropertyClass::Struct, "InFrameRate", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000008000182, 1, nullptr, STRUCT_OFFSET(SystemTimeTimecodeProvider_eventSetFrameRate_Parms, InFrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(Z_Construct_UFunction_USystemTimeTimecodeProvider_SetFrameRate_Statics::NewProp_InFrameRate_MetaData, ARRAY_COUNT(Z_Construct_UFunction_USystemTimeTimecodeProvider_SetFrameRate_Statics::NewProp_InFrameRate_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USystemTimeTimecodeProvider_SetFrameRate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USystemTimeTimecodeProvider, "SetFrameRate", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00420401, sizeof(SystemTimeTimecodeProvider_eventSetFrameRate_Parms), Z_Construct_UFunction_USystemTimeTimecodeProvider_SetFrameRate_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_USystemTimeTimecodeProvider_SetFrameRate_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USystemTimeTimecodeProvider_SetFrameRate_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_USystemTimeTimecodeProvider_SetFrameRate_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USystemTimeTimecodeProvider_SetFrameRate, "SetFrameRate" }, // 2805039577
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_FrameRate = { UE4CodeGen_Private::EPropertyClass::Struct, "FrameRate", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000001, 1, nullptr, STRUCT_OFFSET(USystemTimeTimecodeProvider, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_FrameRate_MetaData, ARRAY_COUNT(Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_FrameRate_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::ClassParams = {
		...
		Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(USystemTimeTimecodeProvider, 650497654);
