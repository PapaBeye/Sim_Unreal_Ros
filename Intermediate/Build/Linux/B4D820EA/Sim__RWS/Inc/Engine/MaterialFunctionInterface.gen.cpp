...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMaterialFunctionUsage_CRC() { return 1610343519U; }
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_ThumbnailInfo = { UE4CodeGen_Private::EPropertyClass::Object, "ThumbnailInfo", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00120008000a0009, 1, nullptr, STRUCT_OFFSET(UMaterialFunctionInterface, ThumbnailInfo), Z_Construct_UClass_UThumbnailInfo_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_ThumbnailInfo_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_ThumbnailInfo_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_CombinedOutputTypes = { UE4CodeGen_Private::EPropertyClass::UInt32, "CombinedOutputTypes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010010800000000, 1, nullptr, STRUCT_OFFSET(UMaterialFunctionInterface, CombinedOutputTypes), METADATA_PARAMS(Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_CombinedOutputTypes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_CombinedOutputTypes_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_CombinedInputTypes = { UE4CodeGen_Private::EPropertyClass::UInt32, "CombinedInputTypes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010010800000000, 1, nullptr, STRUCT_OFFSET(UMaterialFunctionInterface, CombinedInputTypes), METADATA_PARAMS(Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_CombinedInputTypes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_CombinedInputTypes_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_MaterialFunctionUsage = { UE4CodeGen_Private::EPropertyClass::Byte, "MaterialFunctionUsage", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020090000000000, 1, nullptr, STRUCT_OFFSET(UMaterialFunctionInterface, MaterialFunctionUsage), Z_Construct_UEnum_Engine_EMaterialFunctionUsage, METADATA_PARAMS(Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_MaterialFunctionUsage_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialFunctionInterface_Statics::NewProp_MaterialFunctionUsage_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialFunctionInterface_Statics::ClassParams = {
		...
		0x008800A0u,
		nullptr, 0,
		Z_Construct_UClass_UMaterialFunctionInterface_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMaterialFunctionInterface_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMaterialFunctionInterface, 45822372);
