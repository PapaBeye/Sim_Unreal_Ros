...
class UScriptStruct* FNodeItem::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ENGINE_API uint32 Get_Z_Construct_UScriptStruct_FNodeItem_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FNodeItem, Z_Construct_UPackage__Script_Engine(), TEXT("NodeItem"), sizeof(FNodeItem), Get_Z_Construct_UScriptStruct_FNodeItem_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFNodeItem
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_Transform = { UE4CodeGen_Private::EPropertyClass::Struct, "Transform", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FNodeItem, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_Transform_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_Transform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_ParentName = { UE4CodeGen_Private::EPropertyClass::Name, "ParentName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FNodeItem, ParentName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_ParentName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_ParentName_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNodeItem_Statics::ReturnStructParams = {
		...
		sizeof(FNodeItem),
		alignof(FNodeItem),
		Z_Construct_UScriptStruct_FNodeItem_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FNodeItem_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FNodeItem_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("NodeItem"), sizeof(FNodeItem), Get_Z_Construct_UScriptStruct_FNodeItem_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FNodeItem_CRC() { return 566973044U; }
	...
	IMPLEMENT_CLASS(UNodeMappingProviderInterface, 779443135);
