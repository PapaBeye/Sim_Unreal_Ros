...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_bIsPIEPlayerStart = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsPIEPlayerStart", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(ANavigationObjectBase), &Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_bIsPIEPlayerStart_SetBit, METADATA_PARAMS(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_bIsPIEPlayerStart_MetaData, ARRAY_COUNT(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_bIsPIEPlayerStart_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_BadSprite = { UE4CodeGen_Private::EPropertyClass::Object, "BadSprite", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000080008, 1, nullptr, STRUCT_OFFSET(ANavigationObjectBase, BadSprite), Z_Construct_UClass_UBillboardComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_BadSprite_MetaData, ARRAY_COUNT(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_BadSprite_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_GoodSprite = { UE4CodeGen_Private::EPropertyClass::Object, "GoodSprite", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000080008, 1, nullptr, STRUCT_OFFSET(ANavigationObjectBase, GoodSprite), Z_Construct_UClass_UBillboardComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_GoodSprite_MetaData, ARRAY_COUNT(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_GoodSprite_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ANavigationObjectBase_Statics::ClassParams = {
		...
		0x009000A1u,
		nullptr, 0,
		Z_Construct_UClass_ANavigationObjectBase_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_ANavigationObjectBase_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(ANavigationObjectBase, 13552302);
