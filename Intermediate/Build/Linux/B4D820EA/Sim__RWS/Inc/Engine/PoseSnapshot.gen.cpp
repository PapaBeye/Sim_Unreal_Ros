...
static struct FScriptStruct_Engine_StaticRegisterNativesFPoseSnapshot
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_bIsValid = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsValid", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FPoseSnapshot), &Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_bIsValid_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_bIsValid_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_bIsValid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_SnapshotName = { UE4CodeGen_Private::EPropertyClass::Name, "SnapshotName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FPoseSnapshot, SnapshotName), METADATA_PARAMS(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_SnapshotName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_SnapshotName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_SkeletalMeshName = { UE4CodeGen_Private::EPropertyClass::Name, "SkeletalMeshName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FPoseSnapshot, SkeletalMeshName), METADATA_PARAMS(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_SkeletalMeshName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_SkeletalMeshName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_BoneNames = { UE4CodeGen_Private::EPropertyClass::Array, "BoneNames", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FPoseSnapshot, BoneNames), METADATA_PARAMS(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_BoneNames_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_BoneNames_MetaData)) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_BoneNames_Inner = { UE4CodeGen_Private::EPropertyClass::Name, "BoneNames", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPoseSnapshot_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FPoseSnapshot_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FPoseSnapshot_CRC() { return 567745896U; }
