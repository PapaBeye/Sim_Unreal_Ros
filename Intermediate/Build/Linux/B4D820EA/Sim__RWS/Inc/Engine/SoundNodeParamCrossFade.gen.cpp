...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_USoundNodeParamCrossFade_Statics::NewProp_ParamName = { UE4CodeGen_Private::EPropertyClass::Name, "ParamName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(USoundNodeParamCrossFade, ParamName), METADATA_PARAMS(Z_Construct_UClass_USoundNodeParamCrossFade_Statics::NewProp_ParamName_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundNodeParamCrossFade_Statics::NewProp_ParamName_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USoundNodeParamCrossFade_Statics::ClassParams = {
		...
		0x000810A0u,
		nullptr, 0,
		Z_Construct_UClass_USoundNodeParamCrossFade_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USoundNodeParamCrossFade_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(USoundNodeParamCrossFade, 3105783473);
