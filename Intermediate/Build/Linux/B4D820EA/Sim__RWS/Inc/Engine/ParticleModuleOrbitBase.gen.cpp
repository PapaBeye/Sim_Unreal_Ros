...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleOrbitBase_Statics::NewProp_bUseEmitterTime = { UE4CodeGen_Private::EPropertyClass::Bool, "bUseEmitterTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleOrbitBase), &Z_Construct_UClass_UParticleModuleOrbitBase_Statics::NewProp_bUseEmitterTime_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleOrbitBase_Statics::NewProp_bUseEmitterTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrbitBase_Statics::NewProp_bUseEmitterTime_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleOrbitBase_Statics::ClassParams = {
		...
		0x000010A1u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleOrbitBase_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrbitBase_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleOrbitBase, 2103553644);
