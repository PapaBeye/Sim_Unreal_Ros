...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_bUseRealTime = { UE4CodeGen_Private::EPropertyClass::Bool, "bUseRealTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleSubUV), &Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_bUseRealTime_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_bUseRealTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_bUseRealTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_SubImageIndex = { UE4CodeGen_Private::EPropertyClass::Struct, "SubImageIndex", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleSubUV, SubImageIndex), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_SubImageIndex_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_SubImageIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_Animation = { UE4CodeGen_Private::EPropertyClass::Object, "Animation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UParticleModuleSubUV, Animation), Z_Construct_UClass_USubUVAnimation_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_Animation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_Animation_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleSubUV_Statics::ClassParams = {
		...
		0x008810A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleSubUV_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSubUV_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleSubUV, 3272321072);
