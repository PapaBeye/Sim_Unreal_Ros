...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_bEmitterTime = { UE4CodeGen_Private::EPropertyClass::Bool, "bEmitterTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleColorScaleOverLife), &Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_bEmitterTime_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_bEmitterTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_bEmitterTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_AlphaScaleOverLife = { UE4CodeGen_Private::EPropertyClass::Struct, "AlphaScaleOverLife", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleColorScaleOverLife, AlphaScaleOverLife), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_AlphaScaleOverLife_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_AlphaScaleOverLife_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_ColorScaleOverLife = { UE4CodeGen_Private::EPropertyClass::Struct, "ColorScaleOverLife", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleColorScaleOverLife, ColorScaleOverLife), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_ColorScaleOverLife_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_ColorScaleOverLife_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::ClassParams = {
		...
		0x008810A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleColorScaleOverLife, 3725467162);
