...
static struct FScriptStruct_Engine_StaticRegisterNativesFNamedCurveValue
{
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNamedCurveValue_Statics::NewProp_Value = { UE4CodeGen_Private::EPropertyClass::Float, "Value", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FNamedCurveValue, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedCurveValue_Statics::NewProp_Value_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedCurveValue_Statics::NewProp_Value_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNamedCurveValue_Statics::NewProp_Name = { UE4CodeGen_Private::EPropertyClass::Name, "Name", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FNamedCurveValue, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedCurveValue_Statics::NewProp_Name_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedCurveValue_Statics::NewProp_Name_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNamedCurveValue_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FNamedCurveValue_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedCurveValue_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FNamedCurveValue_CRC() { return 3733558710U; }
	...
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UCurveSourceInterface_GetBindingName_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Name, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(CurveSourceInterface_eventGetBindingName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCurveSourceInterface_GetBindingName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCurveSourceInterface, "GetBindingName", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x48020C00, sizeof(CurveSourceInterface_eventGetBindingName_Parms), Z_Construct_UFunction_UCurveSourceInterface_GetBindingName_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCurveSourceInterface_GetBindingName_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCurveSourceInterface_GetBindingName_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCurveSourceInterface_GetBindingName_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UCurveSourceInterface_GetCurves_Statics::NewProp_OutValues = { UE4CodeGen_Private::EPropertyClass::Array, "OutValues", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000180, 1, nullptr, STRUCT_OFFSET(CurveSourceInterface_eventGetCurves_Parms, OutValues), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCurveSourceInterface_GetCurves_Statics::NewProp_OutValues_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "OutValues", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FNamedCurveValue, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCurveSourceInterface_GetCurves_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCurveSourceInterface, "GetCurves", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x48420C00, sizeof(CurveSourceInterface_eventGetCurves_Parms), Z_Construct_UFunction_UCurveSourceInterface_GetCurves_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCurveSourceInterface_GetCurves_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCurveSourceInterface_GetCurves_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCurveSourceInterface_GetCurves_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCurveSourceInterface_GetCurveValue_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Float, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(CurveSourceInterface_eventGetCurveValue_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UCurveSourceInterface_GetCurveValue_Statics::NewProp_CurveName = { UE4CodeGen_Private::EPropertyClass::Name, "CurveName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(CurveSourceInterface_eventGetCurveValue_Parms, CurveName), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCurveSourceInterface_GetCurveValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCurveSourceInterface, "GetCurveValue", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x48020C00, sizeof(CurveSourceInterface_eventGetCurveValue_Parms), Z_Construct_UFunction_UCurveSourceInterface_GetCurveValue_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCurveSourceInterface_GetCurveValue_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCurveSourceInterface_GetCurveValue_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCurveSourceInterface_GetCurveValue_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCurveSourceInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCurveSourceInterface_GetBindingName, "GetBindingName" }, // 668736310
		{ &Z_Construct_UFunction_UCurveSourceInterface_GetCurves, "GetCurves" }, // 440462986
		{ &Z_Construct_UFunction_UCurveSourceInterface_GetCurveValue, "GetCurveValue" }, // 747880368
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCurveSourceInterface, 3269828618);
