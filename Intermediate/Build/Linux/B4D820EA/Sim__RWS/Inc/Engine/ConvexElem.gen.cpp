...
static struct FScriptStruct_Engine_StaticRegisterNativesFKConvexElem
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_Transform = { UE4CodeGen_Private::EPropertyClass::Struct, "Transform", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FKConvexElem, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_Transform_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_Transform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_ElemBox = { UE4CodeGen_Private::EPropertyClass::Struct, "ElemBox", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FKConvexElem, ElemBox), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_ElemBox_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_ElemBox_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_VertexData = { UE4CodeGen_Private::EPropertyClass::Array, "VertexData", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FKConvexElem, VertexData), METADATA_PARAMS(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_VertexData_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_VertexData_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_VertexData_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "VertexData", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FKConvexElem_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FKConvexElem_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FKConvexElem_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FKConvexElem_CRC() { return 3844734551U; }
