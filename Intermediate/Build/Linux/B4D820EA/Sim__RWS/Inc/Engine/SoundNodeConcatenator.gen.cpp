...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USoundNodeConcatenator_Statics::NewProp_InputVolume = { UE4CodeGen_Private::EPropertyClass::Array, "InputVolume", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000041, 1, nullptr, STRUCT_OFFSET(USoundNodeConcatenator, InputVolume), METADATA_PARAMS(Z_Construct_UClass_USoundNodeConcatenator_Statics::NewProp_InputVolume_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundNodeConcatenator_Statics::NewProp_InputVolume_MetaData)) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeConcatenator_Statics::NewProp_InputVolume_Inner = { UE4CodeGen_Private::EPropertyClass::Float, "InputVolume", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USoundNodeConcatenator_Statics::ClassParams = {
		...
		0x000810A0u,
		nullptr, 0,
		Z_Construct_UClass_USoundNodeConcatenator_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USoundNodeConcatenator_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(USoundNodeConcatenator, 1970481478);
