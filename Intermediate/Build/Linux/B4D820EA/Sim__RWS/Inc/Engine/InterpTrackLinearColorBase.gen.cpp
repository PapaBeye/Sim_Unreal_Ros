...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UInterpTrackLinearColorBase_Statics::NewProp_CurveTension = { UE4CodeGen_Private::EPropertyClass::Float, "CurveTension", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UInterpTrackLinearColorBase, CurveTension), METADATA_PARAMS(Z_Construct_UClass_UInterpTrackLinearColorBase_Statics::NewProp_CurveTension_MetaData, ARRAY_COUNT(Z_Construct_UClass_UInterpTrackLinearColorBase_Statics::NewProp_CurveTension_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInterpTrackLinearColorBase_Statics::NewProp_LinearColorTrack = { UE4CodeGen_Private::EPropertyClass::Struct, "LinearColorTrack", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UInterpTrackLinearColorBase, LinearColorTrack), Z_Construct_UScriptStruct_FInterpCurveLinearColor, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackLinearColorBase_Statics::NewProp_LinearColorTrack_MetaData, ARRAY_COUNT(Z_Construct_UClass_UInterpTrackLinearColorBase_Statics::NewProp_LinearColorTrack_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UInterpTrackLinearColorBase_Statics::ClassParams = {
		...
		0x000820A1u,
		nullptr, 0,
		Z_Construct_UClass_UInterpTrackLinearColorBase_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UInterpTrackLinearColorBase_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UInterpTrackLinearColorBase, 3877536622);
