...
static struct FScriptStruct_Engine_StaticRegisterNativesFStringCurve
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys = { UE4CodeGen_Private::EPropertyClass::Array, "Keys", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000041, 1, nullptr, STRUCT_OFFSET(FStringCurve, Keys), METADATA_PARAMS(Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "Keys", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FStringCurveKey, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_DefaultValue = { UE4CodeGen_Private::EPropertyClass::Str, "DefaultValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FStringCurve, DefaultValue), METADATA_PARAMS(Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_DefaultValue_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_DefaultValue_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FStringCurve_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FStringCurve_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurve_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FStringCurve_CRC() { return 894273965U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStringCurveKey
{
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Value = { UE4CodeGen_Private::EPropertyClass::Str, "Value", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FStringCurveKey, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Value_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Value_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Time = { UE4CodeGen_Private::EPropertyClass::Float, "Time", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FStringCurveKey, Time), METADATA_PARAMS(Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Time_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Time_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FStringCurveKey_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FStringCurveKey_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurveKey_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FStringCurveKey_CRC() { return 2287480792U; }
