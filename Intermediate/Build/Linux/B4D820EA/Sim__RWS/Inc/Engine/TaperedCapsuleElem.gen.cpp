...
class UScriptStruct* FKTaperedCapsuleElem::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ENGINE_API uint32 Get_Z_Construct_UScriptStruct_FKTaperedCapsuleElem_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FKTaperedCapsuleElem, Z_Construct_UPackage__Script_Engine(), TEXT("KTaperedCapsuleElem"), sizeof(FKTaperedCapsuleElem), Get_Z_Construct_UScriptStruct_FKTaperedCapsuleElem_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFKTaperedCapsuleElem
{
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Length = { UE4CodeGen_Private::EPropertyClass::Float, "Length", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FKTaperedCapsuleElem, Length), METADATA_PARAMS(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Length_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Length_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Radius1 = { UE4CodeGen_Private::EPropertyClass::Float, "Radius1", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FKTaperedCapsuleElem, Radius1), METADATA_PARAMS(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Radius1_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Radius1_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Radius0 = { UE4CodeGen_Private::EPropertyClass::Float, "Radius0", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FKTaperedCapsuleElem, Radius0), METADATA_PARAMS(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Radius0_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Radius0_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Rotation = { UE4CodeGen_Private::EPropertyClass::Struct, "Rotation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FKTaperedCapsuleElem, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Rotation_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Rotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Center = { UE4CodeGen_Private::EPropertyClass::Struct, "Center", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FKTaperedCapsuleElem, Center), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Center_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewProp_Center_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FKTaperedCapsuleElem_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("KTaperedCapsuleElem"), sizeof(FKTaperedCapsuleElem), Get_Z_Construct_UScriptStruct_FKTaperedCapsuleElem_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FKTaperedCapsuleElem_CRC() { return 4119442052U; }
