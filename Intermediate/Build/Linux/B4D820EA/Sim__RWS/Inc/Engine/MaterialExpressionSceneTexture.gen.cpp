...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ESceneTextureId_CRC() { return 4237686314U; }
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_bFiltered = { UE4CodeGen_Private::EPropertyClass::Bool, "bFiltered", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UMaterialExpressionSceneTexture), &Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_bFiltered_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_bFiltered_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_bFiltered_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_SceneTextureId = { UE4CodeGen_Private::EPropertyClass::Byte, "SceneTextureId", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionSceneTexture, SceneTextureId), Z_Construct_UEnum_Engine_ESceneTextureId, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_SceneTextureId_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_SceneTextureId_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_Coordinates = { UE4CodeGen_Private::EPropertyClass::Struct, "Coordinates", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionSceneTexture, Coordinates), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_Coordinates_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::NewProp_Coordinates_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::ClassParams = {
		...
		0x000020A0u,
		nullptr, 0,
		Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSceneTexture_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMaterialExpressionSceneTexture, 3342189074);
