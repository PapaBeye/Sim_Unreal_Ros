...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_RebaseOriginDistance = { UE4CodeGen_Private::EPropertyClass::Float, "RebaseOriginDistance", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, STRUCT_OFFSET(UWorldComposition, RebaseOriginDistance), METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_RebaseOriginDistance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_RebaseOriginDistance_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLockTilesLocation = { UE4CodeGen_Private::EPropertyClass::Bool, "bLockTilesLocation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000800000000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UWorldComposition), &Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLockTilesLocation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLockTilesLocation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLockTilesLocation_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_bRebaseOriginIn3DSpace = { UE4CodeGen_Private::EPropertyClass::Bool, "bRebaseOriginIn3DSpace", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UWorldComposition), &Z_Construct_UClass_UWorldComposition_Statics::NewProp_bRebaseOriginIn3DSpace_SetBit, METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bRebaseOriginIn3DSpace_MetaData, ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bRebaseOriginIn3DSpace_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLoadAllTilesDuringCinematic = { UE4CodeGen_Private::EPropertyClass::Bool, "bLoadAllTilesDuringCinematic", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UWorldComposition), &Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLoadAllTilesDuringCinematic_SetBit, METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLoadAllTilesDuringCinematic_MetaData, ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLoadAllTilesDuringCinematic_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreamingTimeThreshold = { UE4CodeGen_Private::EPropertyClass::Double, "TilesStreamingTimeThreshold", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, STRUCT_OFFSET(UWorldComposition, TilesStreamingTimeThreshold), METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreamingTimeThreshold_MetaData, ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreamingTimeThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreaming = { UE4CodeGen_Private::EPropertyClass::Array, "TilesStreaming", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000002000, 1, nullptr, STRUCT_OFFSET(UWorldComposition, TilesStreaming), METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreaming_MetaData, ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreaming_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreaming_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "TilesStreaming", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UClass_ULevelStreaming_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UWorldComposition_Statics::ClassParams = {
		...
		0x001000A4u,
		nullptr, 0,
		Z_Construct_UClass_UWorldComposition_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UWorldComposition, 915754847);
