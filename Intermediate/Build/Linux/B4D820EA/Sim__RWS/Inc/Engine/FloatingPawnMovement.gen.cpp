...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_bPositionCorrected = { UE4CodeGen_Private::EPropertyClass::Bool, "bPositionCorrected", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000002000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UFloatingPawnMovement), &Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_bPositionCorrected_SetBit, METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_bPositionCorrected_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_bPositionCorrected_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_TurningBoost = { UE4CodeGen_Private::EPropertyClass::Float, "TurningBoost", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UFloatingPawnMovement, TurningBoost), METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_TurningBoost_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_TurningBoost_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Deceleration = { UE4CodeGen_Private::EPropertyClass::Float, "Deceleration", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UFloatingPawnMovement, Deceleration), METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Deceleration_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Deceleration_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Acceleration = { UE4CodeGen_Private::EPropertyClass::Float, "Acceleration", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UFloatingPawnMovement, Acceleration), METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Acceleration_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Acceleration_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_MaxSpeed = { UE4CodeGen_Private::EPropertyClass::Float, "MaxSpeed", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UFloatingPawnMovement, MaxSpeed), METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_MaxSpeed_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_MaxSpeed_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UFloatingPawnMovement_Statics::ClassParams = {
		...
		0x00B000A4u,
		nullptr, 0,
		Z_Construct_UClass_UFloatingPawnMovement_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UFloatingPawnMovement, 3186425305);
