...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_bApplyGlobalSpawnRateScale = { UE4CodeGen_Private::EPropertyClass::Bool, "bApplyGlobalSpawnRateScale", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleSpawn), &Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_bApplyGlobalSpawnRateScale_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_bApplyGlobalSpawnRateScale_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_bApplyGlobalSpawnRateScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstScale = { UE4CodeGen_Private::EPropertyClass::Struct, "BurstScale", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleSpawn, BurstScale), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstScale_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstList = { UE4CodeGen_Private::EPropertyClass::Array, "BurstList", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000002000009, 1, nullptr, STRUCT_OFFSET(UParticleModuleSpawn, BurstList), METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstList_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstList_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstList_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "BurstList", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000008, 1, nullptr, 0, Z_Construct_UScriptStruct_FParticleBurst, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_RateScale = { UE4CodeGen_Private::EPropertyClass::Struct, "RateScale", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleSpawn, RateScale), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_RateScale_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_RateScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_Rate = { UE4CodeGen_Private::EPropertyClass::Struct, "Rate", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleSpawn, Rate), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_Rate_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_Rate_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleSpawn_Statics::ClassParams = {
		...
		0x008810A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleSpawn_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawn_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleSpawn, 2020657468);
