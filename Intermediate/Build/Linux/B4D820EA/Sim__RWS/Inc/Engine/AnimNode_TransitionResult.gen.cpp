...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNode_TransitionResult
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::NewProp_bCanEnterTransition = { UE4CodeGen_Private::EPropertyClass::Bool, "bCanEnterTransition", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FAnimNode_TransitionResult), &Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::NewProp_bCanEnterTransition_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::NewProp_bCanEnterTransition_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::NewProp_bCanEnterTransition_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_TransitionResult_CRC() { return 1803834433U; }
