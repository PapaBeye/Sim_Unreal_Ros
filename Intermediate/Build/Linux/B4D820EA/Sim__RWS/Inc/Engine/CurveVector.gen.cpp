...
// End Cross Module References
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCurveVector_GetVectorValue_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Struct, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(CurveVector_eventGetVectorValue_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCurveVector_GetVectorValue_Statics::NewProp_InTime = { UE4CodeGen_Private::EPropertyClass::Float, "InTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(CurveVector_eventGetVectorValue_Parms, InTime), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCurveVector_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCurveVector_GetVectorValue, "GetVectorValue" }, // 3420218326
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCurveVector_Statics::NewProp_FloatCurves = { UE4CodeGen_Private::EPropertyClass::Struct, "FloatCurves", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, CPP_ARRAY_DIM(FloatCurves, UCurveVector), nullptr, STRUCT_OFFSET(UCurveVector, FloatCurves), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(Z_Construct_UClass_UCurveVector_Statics::NewProp_FloatCurves_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCurveVector_Statics::NewProp_FloatCurves_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UCurveVector_Statics::ClassParams = {
		...
		Z_Construct_UClass_UCurveVector_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UCurveVector_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UCurveVector, 744147793);
