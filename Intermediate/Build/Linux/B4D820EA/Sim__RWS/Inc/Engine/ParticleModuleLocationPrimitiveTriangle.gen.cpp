...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_Thickness = { UE4CodeGen_Private::EPropertyClass::Struct, "Thickness", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleLocationPrimitiveTriangle, Thickness), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_Thickness_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_Thickness_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_Angle = { UE4CodeGen_Private::EPropertyClass::Struct, "Angle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleLocationPrimitiveTriangle, Angle), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_Angle_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_Angle_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_Height = { UE4CodeGen_Private::EPropertyClass::Struct, "Height", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleLocationPrimitiveTriangle, Height), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_Height_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_Height_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_StartOffset = { UE4CodeGen_Private::EPropertyClass::Struct, "StartOffset", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleLocationPrimitiveTriangle, StartOffset), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_StartOffset_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::NewProp_StartOffset_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::ClassParams = {
		...
		0x009010A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveTriangle_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleLocationPrimitiveTriangle, 516907135);
