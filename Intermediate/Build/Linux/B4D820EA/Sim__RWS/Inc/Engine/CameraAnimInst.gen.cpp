...
// End Cross Module References
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCameraAnimInst_SetDuration_Statics::NewProp_NewDuration = { UE4CodeGen_Private::EPropertyClass::Float, "NewDuration", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(CameraAnimInst_eventSetDuration_Parms, NewDuration), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCameraAnimInst_SetDuration_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCameraAnimInst, "SetDuration", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(CameraAnimInst_eventSetDuration_Parms), Z_Construct_UFunction_UCameraAnimInst_SetDuration_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCameraAnimInst_SetDuration_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCameraAnimInst_SetDuration_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCameraAnimInst_SetDuration_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCameraAnimInst_SetScale_Statics::NewProp_NewDuration = { UE4CodeGen_Private::EPropertyClass::Float, "NewDuration", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(CameraAnimInst_eventSetScale_Parms, NewDuration), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCameraAnimInst_SetScale_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCameraAnimInst, "SetScale", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(CameraAnimInst_eventSetScale_Parms), Z_Construct_UFunction_UCameraAnimInst_SetScale_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCameraAnimInst_SetScale_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCameraAnimInst_SetScale_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCameraAnimInst_SetScale_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UCameraAnimInst_Stop_Statics::NewProp_bImmediate = { UE4CodeGen_Private::EPropertyClass::Bool, "bImmediate", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(CameraAnimInst_eventStop_Parms), &Z_Construct_UFunction_UCameraAnimInst_Stop_Statics::NewProp_bImmediate_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCameraAnimInst_Stop_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCameraAnimInst, "Stop", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(CameraAnimInst_eventStop_Parms), Z_Construct_UFunction_UCameraAnimInst_Stop_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCameraAnimInst_Stop_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCameraAnimInst_Stop_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCameraAnimInst_Stop_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCameraAnimInst_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCameraAnimInst_SetDuration, "SetDuration" }, // 1860112894
		{ &Z_Construct_UFunction_UCameraAnimInst_SetScale, "SetScale" }, // 3254495808
		{ &Z_Construct_UFunction_UCameraAnimInst_Stop, "Stop" }, // 2361016034
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_PlaySpace = { UE4CodeGen_Private::EPropertyClass::Byte, "PlaySpace", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UCameraAnimInst, PlaySpace), Z_Construct_UEnum_Engine_ECameraAnimPlaySpace, METADATA_PARAMS(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_PlaySpace_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_PlaySpace_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_MoveInst_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Camera/CameraAnimInst.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_MoveInst = { UE4CodeGen_Private::EPropertyClass::Object, "MoveInst", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000002000, 1, nullptr, STRUCT_OFFSET(UCameraAnimInst, MoveInst), Z_Construct_UClass_UInterpTrackInstMove_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_MoveInst_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_MoveInst_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_MoveTrack = { UE4CodeGen_Private::EPropertyClass::Object, "MoveTrack", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000002000, 1, nullptr, STRUCT_OFFSET(UCameraAnimInst, MoveTrack), Z_Construct_UClass_UInterpTrackMove_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_MoveTrack_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_MoveTrack_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_PlayRate = { UE4CodeGen_Private::EPropertyClass::Float, "PlayRate", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000004, 1, nullptr, STRUCT_OFFSET(UCameraAnimInst, PlayRate), METADATA_PARAMS(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_PlayRate_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_PlayRate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_InterpGroupInst = { UE4CodeGen_Private::EPropertyClass::Object, "InterpGroupInst", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0042000000080008, 1, nullptr, STRUCT_OFFSET(UCameraAnimInst, InterpGroupInst), Z_Construct_UClass_UInterpGroupInst_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_InterpGroupInst_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_InterpGroupInst_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_CamAnim = { UE4CodeGen_Private::EPropertyClass::Object, "CamAnim", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UCameraAnimInst, CamAnim), Z_Construct_UClass_UCameraAnim_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_CamAnim_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCameraAnimInst_Statics::NewProp_CamAnim_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UCameraAnimInst_Statics::ClassParams = {
		...
		Z_Construct_UClass_UCameraAnimInst_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UCameraAnimInst_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UCameraAnimInst, 3398338925);
