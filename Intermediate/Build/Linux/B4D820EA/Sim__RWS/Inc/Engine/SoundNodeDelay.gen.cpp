...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMax = { UE4CodeGen_Private::EPropertyClass::Float, "DelayMax", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(USoundNodeDelay, DelayMax), METADATA_PARAMS(Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMax_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMax_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMin = { UE4CodeGen_Private::EPropertyClass::Float, "DelayMin", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(USoundNodeDelay, DelayMin), METADATA_PARAMS(Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMin_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMin_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USoundNodeDelay_Statics::ClassParams = {
		...
		0x000810A0u,
		nullptr, 0,
		Z_Construct_UClass_USoundNodeDelay_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USoundNodeDelay_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(USoundNodeDelay, 2201016545);
