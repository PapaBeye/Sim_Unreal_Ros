...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASkyLight_OnRep_bEnabled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASkyLight, "OnRep_bEnabled", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00020400, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASkyLight_OnRep_bEnabled_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ASkyLight_OnRep_bEnabled_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASkyLight_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASkyLight_OnRep_bEnabled, "OnRep_bEnabled" }, // 2603806800
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ASkyLight_Statics::NewProp_bEnabled = { UE4CodeGen_Private::EPropertyClass::Bool, "bEnabled", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000100000020, 1, "OnRep_bEnabled", sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(ASkyLight), &Z_Construct_UClass_ASkyLight_Statics::NewProp_bEnabled_SetBit, METADATA_PARAMS(Z_Construct_UClass_ASkyLight_Statics::NewProp_bEnabled_MetaData, ARRAY_COUNT(Z_Construct_UClass_ASkyLight_Statics::NewProp_bEnabled_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASkyLight_Statics::NewProp_LightComponent = { UE4CodeGen_Private::EPropertyClass::Object, "LightComponent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00400000000a001d, 1, nullptr, STRUCT_OFFSET(ASkyLight, LightComponent), Z_Construct_UClass_USkyLightComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASkyLight_Statics::NewProp_LightComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_ASkyLight_Statics::NewProp_LightComponent_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ASkyLight_Statics::ClassParams = {
		...
		Z_Construct_UClass_ASkyLight_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_ASkyLight_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(ASkyLight, 676607329);
