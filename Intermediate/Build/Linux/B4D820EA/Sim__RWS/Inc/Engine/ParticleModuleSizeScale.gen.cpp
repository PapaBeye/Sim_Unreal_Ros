...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableZ = { UE4CodeGen_Private::EPropertyClass::Bool, "EnableZ", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleSizeScale), &Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableZ_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableZ_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableZ_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableY = { UE4CodeGen_Private::EPropertyClass::Bool, "EnableY", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleSizeScale), &Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableY_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableY_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableY_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableX = { UE4CodeGen_Private::EPropertyClass::Bool, "EnableX", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleSizeScale), &Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableX_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableX_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSizeScale_Statics::NewProp_EnableX_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleSizeScale_Statics::ClassParams = {
		...
		0x008810A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleSizeScale_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSizeScale_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleSizeScale, 3414313270);
