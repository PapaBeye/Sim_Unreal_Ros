...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::NewProp_DynamicIndirect = { UE4CodeGen_Private::EPropertyClass::Struct, "DynamicIndirect", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionGIReplace, DynamicIndirect), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::NewProp_DynamicIndirect_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::NewProp_DynamicIndirect_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::NewProp_StaticIndirect = { UE4CodeGen_Private::EPropertyClass::Struct, "StaticIndirect", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionGIReplace, StaticIndirect), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::NewProp_StaticIndirect_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::NewProp_StaticIndirect_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::NewProp_Default = { UE4CodeGen_Private::EPropertyClass::Struct, "Default", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionGIReplace, Default), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::NewProp_Default_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::NewProp_Default_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::ClassParams = {
		...
		0x000000A0u,
		nullptr, 0,
		Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionGIReplace_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMaterialExpressionGIReplace, 156725715);
