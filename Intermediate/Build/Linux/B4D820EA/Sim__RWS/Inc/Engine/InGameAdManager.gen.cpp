...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Engine_OnUserClosedAdvertisement__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Engine, "OnUserClosedAdvertisement__DelegateSignature", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00120000, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Engine_OnUserClosedAdvertisement__DelegateSignature_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_OnUserClosedAdvertisement__DelegateSignature_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Engine_OnUserClickedBanner__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Engine, "OnUserClickedBanner__DelegateSignature", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00120000, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Engine_OnUserClickedBanner__DelegateSignature_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_OnUserClickedBanner__DelegateSignature_Statics::Function_MetaDataParams)) };
	...
	uint32 Get_Z_Construct_UEnum_Engine_EAdManagerDelegate_CRC() { return 2248369998U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClosedAdDelegates = { UE4CodeGen_Private::EPropertyClass::Array, "ClosedAdDelegates", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000000, 1, nullptr, STRUCT_OFFSET(UInGameAdManager, ClosedAdDelegates), METADATA_PARAMS(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClosedAdDelegates_MetaData, ARRAY_COUNT(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClosedAdDelegates_MetaData)) };
	const UE4CodeGen_Private::FDelegatePropertyParams Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClosedAdDelegates_Inner = { UE4CodeGen_Private::EPropertyClass::Delegate, "ClosedAdDelegates", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000080000, 1, nullptr, 0, Z_Construct_UDelegateFunction_Engine_OnUserClosedAdvertisement__DelegateSignature, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClickedBannerDelegates = { UE4CodeGen_Private::EPropertyClass::Array, "ClickedBannerDelegates", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000000, 1, nullptr, STRUCT_OFFSET(UInGameAdManager, ClickedBannerDelegates), METADATA_PARAMS(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClickedBannerDelegates_MetaData, ARRAY_COUNT(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClickedBannerDelegates_MetaData)) };
	const UE4CodeGen_Private::FDelegatePropertyParams Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClickedBannerDelegates_Inner = { UE4CodeGen_Private::EPropertyClass::Delegate, "ClickedBannerDelegates", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000080000, 1, nullptr, 0, Z_Construct_UDelegateFunction_Engine_OnUserClickedBanner__DelegateSignature, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UInGameAdManager_Statics::NewProp_bShouldPauseWhileAdOpen = { UE4CodeGen_Private::EPropertyClass::Bool, "bShouldPauseWhileAdOpen", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UInGameAdManager), &Z_Construct_UClass_UInGameAdManager_Statics::NewProp_bShouldPauseWhileAdOpen_SetBit, METADATA_PARAMS(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_bShouldPauseWhileAdOpen_MetaData, ARRAY_COUNT(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_bShouldPauseWhileAdOpen_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UInGameAdManager_Statics::ClassParams = {
		...
		0x008000A8u,
		nullptr, 0,
		Z_Construct_UClass_UInGameAdManager_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UInGameAdManager_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UInGameAdManager, 926158508);
