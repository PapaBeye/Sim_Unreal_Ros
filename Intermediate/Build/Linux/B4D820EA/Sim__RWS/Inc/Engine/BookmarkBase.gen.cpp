...
class UScriptStruct* FBookmarkBaseJumpToSettings::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ENGINE_API uint32 Get_Z_Construct_UScriptStruct_FBookmarkBaseJumpToSettings_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FBookmarkBaseJumpToSettings, Z_Construct_UPackage__Script_Engine(), TEXT("BookmarkBaseJumpToSettings"), sizeof(FBookmarkBaseJumpToSettings), Get_Z_Construct_UScriptStruct_FBookmarkBaseJumpToSettings_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFBookmarkBaseJumpToSettings
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FBookmarkBaseJumpToSettings_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("BookmarkBaseJumpToSettings"), sizeof(FBookmarkBaseJumpToSettings), Get_Z_Construct_UScriptStruct_FBookmarkBaseJumpToSettings_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FBookmarkBaseJumpToSettings_CRC() { return 1844558262U; }
	...
	IMPLEMENT_CLASS(UBookmarkBase, 2677819471);
