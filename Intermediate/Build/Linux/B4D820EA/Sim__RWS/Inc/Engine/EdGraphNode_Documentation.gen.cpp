...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEdGraphNode_Documentation_Statics::NewProp_Excerpt = { UE4CodeGen_Private::EPropertyClass::Str, "Excerpt", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UEdGraphNode_Documentation, Excerpt), METADATA_PARAMS(Z_Construct_UClass_UEdGraphNode_Documentation_Statics::NewProp_Excerpt_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEdGraphNode_Documentation_Statics::NewProp_Excerpt_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEdGraphNode_Documentation_Statics::NewProp_Link = { UE4CodeGen_Private::EPropertyClass::Str, "Link", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UEdGraphNode_Documentation, Link), METADATA_PARAMS(Z_Construct_UClass_UEdGraphNode_Documentation_Statics::NewProp_Link_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEdGraphNode_Documentation_Statics::NewProp_Link_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UEdGraphNode_Documentation_Statics::ClassParams = {
		...
		0x000800A0u,
		nullptr, 0,
		Z_Construct_UClass_UEdGraphNode_Documentation_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UEdGraphNode_Documentation_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UEdGraphNode_Documentation, 1722894562);
