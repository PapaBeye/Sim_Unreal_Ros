...
class UScriptStruct* FBookmarkJumpToSettings::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ENGINE_API uint32 Get_Z_Construct_UScriptStruct_FBookmarkJumpToSettings_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FBookmarkJumpToSettings, Z_Construct_UPackage__Script_Engine(), TEXT("BookmarkJumpToSettings"), sizeof(FBookmarkJumpToSettings), Get_Z_Construct_UScriptStruct_FBookmarkJumpToSettings_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFBookmarkJumpToSettings
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FBookmarkJumpToSettings_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("BookmarkJumpToSettings"), sizeof(FBookmarkJumpToSettings), Get_Z_Construct_UScriptStruct_FBookmarkJumpToSettings_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FBookmarkJumpToSettings_CRC() { return 3772058939U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBookMark_Statics::NewProp_HiddenLevels = { UE4CodeGen_Private::EPropertyClass::Array, "HiddenLevels", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UBookMark, HiddenLevels), METADATA_PARAMS(Z_Construct_UClass_UBookMark_Statics::NewProp_HiddenLevels_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBookMark_Statics::NewProp_HiddenLevels_MetaData)) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UBookMark_Statics::NewProp_HiddenLevels_Inner = { UE4CodeGen_Private::EPropertyClass::Str, "HiddenLevels", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBookMark_Statics::NewProp_Rotation = { UE4CodeGen_Private::EPropertyClass::Struct, "Rotation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UBookMark, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_UBookMark_Statics::NewProp_Rotation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBookMark_Statics::NewProp_Rotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBookMark_Statics::NewProp_Location = { UE4CodeGen_Private::EPropertyClass::Struct, "Location", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UBookMark, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UBookMark_Statics::NewProp_Location_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBookMark_Statics::NewProp_Location_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBookMark_Statics::ClassParams = {
		...
		0x000800A0u,
		nullptr, 0,
		Z_Construct_UClass_UBookMark_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UBookMark_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UBookMark, 1505654423);
