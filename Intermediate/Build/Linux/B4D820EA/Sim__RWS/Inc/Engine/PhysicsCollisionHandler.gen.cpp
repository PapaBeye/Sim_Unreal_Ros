...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_LastImpactSoundTime = { UE4CodeGen_Private::EPropertyClass::Float, "LastImpactSoundTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UPhysicsCollisionHandler, LastImpactSoundTime), METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_LastImpactSoundTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_LastImpactSoundTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_DefaultImpactSound = { UE4CodeGen_Private::EPropertyClass::Object, "DefaultImpactSound", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UPhysicsCollisionHandler, DefaultImpactSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_DefaultImpactSound_MetaData, ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_DefaultImpactSound_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactReFireDelay = { UE4CodeGen_Private::EPropertyClass::Float, "ImpactReFireDelay", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UPhysicsCollisionHandler, ImpactReFireDelay), METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactReFireDelay_MetaData, ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactReFireDelay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactThreshold = { UE4CodeGen_Private::EPropertyClass::Float, "ImpactThreshold", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UPhysicsCollisionHandler, ImpactThreshold), METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactThreshold_MetaData, ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactThreshold_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::ClassParams = {
		...
		0x001000A0u,
		nullptr, 0,
		Z_Construct_UClass_UPhysicsCollisionHandler_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UPhysicsCollisionHandler, 573201628);
