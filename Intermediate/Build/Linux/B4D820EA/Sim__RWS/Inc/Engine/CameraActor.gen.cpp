...
// End Cross Module References
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Int, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(CameraActor_eventGetAutoActivatePlayerIndex_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ACameraActor, "GetAutoActivatePlayerIndex", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x54020401, sizeof(CameraActor_eventGetAutoActivatePlayerIndex_Parms), Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACameraActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex, "GetAutoActivatePlayerIndex" }, // 2274378578
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACameraActor_Statics::NewProp_PostProcessSettings = { UE4CodeGen_Private::EPropertyClass::Struct, "PostProcessSettings", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000020000000, 1, nullptr, STRUCT_OFFSET(ACameraActor, PostProcessSettings_DEPRECATED), Z_Construct_UScriptStruct_FPostProcessSettings, METADATA_PARAMS(Z_Construct_UClass_ACameraActor_Statics::NewProp_PostProcessSettings_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACameraActor_Statics::NewProp_PostProcessSettings_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACameraActor_Statics::NewProp_PostProcessBlendWeight = { UE4CodeGen_Private::EPropertyClass::Float, "PostProcessBlendWeight", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000020000000, 1, nullptr, STRUCT_OFFSET(ACameraActor, PostProcessBlendWeight_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_ACameraActor_Statics::NewProp_PostProcessBlendWeight_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACameraActor_Statics::NewProp_PostProcessBlendWeight_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACameraActor_Statics::NewProp_FOVAngle_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Camera/CameraActor.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACameraActor_Statics::NewProp_FOVAngle = { UE4CodeGen_Private::EPropertyClass::Float, "FOVAngle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000020000000, 1, nullptr, STRUCT_OFFSET(ACameraActor, FOVAngle_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_ACameraActor_Statics::NewProp_FOVAngle_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACameraActor_Statics::NewProp_FOVAngle_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACameraActor_Statics::NewProp_AspectRatio_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Camera/CameraActor.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACameraActor_Statics::NewProp_AspectRatio = { UE4CodeGen_Private::EPropertyClass::Float, "AspectRatio", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000020000000, 1, nullptr, STRUCT_OFFSET(ACameraActor, AspectRatio_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_ACameraActor_Statics::NewProp_AspectRatio_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACameraActor_Statics::NewProp_AspectRatio_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACameraActor_Statics::NewProp_bConstrainAspectRatio = { UE4CodeGen_Private::EPropertyClass::Bool, "bConstrainAspectRatio", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000020000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(ACameraActor), &Z_Construct_UClass_ACameraActor_Statics::NewProp_bConstrainAspectRatio_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACameraActor_Statics::NewProp_bConstrainAspectRatio_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACameraActor_Statics::NewProp_bConstrainAspectRatio_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACameraActor_Statics::NewProp_SceneComponent = { UE4CodeGen_Private::EPropertyClass::Object, "SceneComponent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00400000000a001d, 1, nullptr, STRUCT_OFFSET(ACameraActor, SceneComponent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACameraActor_Statics::NewProp_SceneComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACameraActor_Statics::NewProp_SceneComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACameraActor_Statics::NewProp_CameraComponent = { UE4CodeGen_Private::EPropertyClass::Object, "CameraComponent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00400000000a001d, 1, nullptr, STRUCT_OFFSET(ACameraActor, CameraComponent), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACameraActor_Statics::NewProp_CameraComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACameraActor_Statics::NewProp_CameraComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_ACameraActor_Statics::NewProp_AutoActivateForPlayer = { UE4CodeGen_Private::EPropertyClass::Byte, "AutoActivateForPlayer", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000001, 1, nullptr, STRUCT_OFFSET(ACameraActor, AutoActivateForPlayer), Z_Construct_UEnum_Engine_EAutoReceiveInput, METADATA_PARAMS(Z_Construct_UClass_ACameraActor_Statics::NewProp_AutoActivateForPlayer_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACameraActor_Statics::NewProp_AutoActivateForPlayer_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ACameraActor_Statics::ClassParams = {
		...
		Z_Construct_UClass_ACameraActor_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_ACameraActor_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(ACameraActor, 2481640949);
