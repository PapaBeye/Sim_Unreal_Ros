...
// End Cross Module References
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USpotLightComponent_SetInnerConeAngle_Statics::NewProp_NewInnerConeAngle = { UE4CodeGen_Private::EPropertyClass::Float, "NewInnerConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(SpotLightComponent_eventSetInnerConeAngle_Parms, NewInnerConeAngle), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USpotLightComponent_SetInnerConeAngle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USpotLightComponent, "SetInnerConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(SpotLightComponent_eventSetInnerConeAngle_Parms), Z_Construct_UFunction_USpotLightComponent_SetInnerConeAngle_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_USpotLightComponent_SetInnerConeAngle_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USpotLightComponent_SetInnerConeAngle_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_USpotLightComponent_SetInnerConeAngle_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USpotLightComponent_SetOuterConeAngle_Statics::NewProp_NewOuterConeAngle = { UE4CodeGen_Private::EPropertyClass::Float, "NewOuterConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(SpotLightComponent_eventSetOuterConeAngle_Parms, NewOuterConeAngle), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USpotLightComponent_SetOuterConeAngle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USpotLightComponent, "SetOuterConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(SpotLightComponent_eventSetOuterConeAngle_Parms), Z_Construct_UFunction_USpotLightComponent_SetOuterConeAngle_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_USpotLightComponent_SetOuterConeAngle_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USpotLightComponent_SetOuterConeAngle_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_USpotLightComponent_SetOuterConeAngle_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USpotLightComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USpotLightComponent_SetInnerConeAngle, "SetInnerConeAngle" }, // 2701030854
		{ &Z_Construct_UFunction_USpotLightComponent_SetOuterConeAngle, "SetOuterConeAngle" }, // 3064212757
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USpotLightComponent_Statics::NewProp_LightShaftConeAngle = { UE4CodeGen_Private::EPropertyClass::Float, "LightShaftConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(USpotLightComponent, LightShaftConeAngle), METADATA_PARAMS(Z_Construct_UClass_USpotLightComponent_Statics::NewProp_LightShaftConeAngle_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpotLightComponent_Statics::NewProp_LightShaftConeAngle_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USpotLightComponent_Statics::NewProp_OuterConeAngle = { UE4CodeGen_Private::EPropertyClass::Float, "OuterConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(USpotLightComponent, OuterConeAngle), METADATA_PARAMS(Z_Construct_UClass_USpotLightComponent_Statics::NewProp_OuterConeAngle_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpotLightComponent_Statics::NewProp_OuterConeAngle_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USpotLightComponent_Statics::NewProp_InnerConeAngle = { UE4CodeGen_Private::EPropertyClass::Float, "InnerConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(USpotLightComponent, InnerConeAngle), METADATA_PARAMS(Z_Construct_UClass_USpotLightComponent_Statics::NewProp_InnerConeAngle_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpotLightComponent_Statics::NewProp_InnerConeAngle_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpotLightComponent_Statics::ClassParams = {
		...
		Z_Construct_UClass_USpotLightComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USpotLightComponent_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(USpotLightComponent, 574319409);
