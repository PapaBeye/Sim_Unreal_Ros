...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UShapeComponent_Statics::NewProp_AreaClass = { UE4CodeGen_Private::EPropertyClass::Class, "AreaClass", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0014000000000001, 1, nullptr, STRUCT_OFFSET(UShapeComponent, AreaClass), Z_Construct_UClass_UNavAreaBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UShapeComponent_Statics::NewProp_AreaClass_MetaData, ARRAY_COUNT(Z_Construct_UClass_UShapeComponent_Statics::NewProp_AreaClass_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UShapeComponent_Statics::NewProp_bShouldCollideWhenPlacing = { UE4CodeGen_Private::EPropertyClass::Bool, "bShouldCollideWhenPlacing", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UShapeComponent), &Z_Construct_UClass_UShapeComponent_Statics::NewProp_bShouldCollideWhenPlacing_SetBit, METADATA_PARAMS(Z_Construct_UClass_UShapeComponent_Statics::NewProp_bShouldCollideWhenPlacing_MetaData, ARRAY_COUNT(Z_Construct_UClass_UShapeComponent_Statics::NewProp_bShouldCollideWhenPlacing_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UShapeComponent_Statics::NewProp_bDrawOnlyIfSelected = { UE4CodeGen_Private::EPropertyClass::Bool, "bDrawOnlyIfSelected", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UShapeComponent), &Z_Construct_UClass_UShapeComponent_Statics::NewProp_bDrawOnlyIfSelected_SetBit, METADATA_PARAMS(Z_Construct_UClass_UShapeComponent_Statics::NewProp_bDrawOnlyIfSelected_MetaData, ARRAY_COUNT(Z_Construct_UClass_UShapeComponent_Statics::NewProp_bDrawOnlyIfSelected_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UShapeComponent_Statics::NewProp_ShapeColor = { UE4CodeGen_Private::EPropertyClass::Struct, "ShapeColor", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010040000000015, 1, nullptr, STRUCT_OFFSET(UShapeComponent, ShapeColor), Z_Construct_UScriptStruct_FColor, METADATA_PARAMS(Z_Construct_UClass_UShapeComponent_Statics::NewProp_ShapeColor_MetaData, ARRAY_COUNT(Z_Construct_UClass_UShapeComponent_Statics::NewProp_ShapeColor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UShapeComponent_Statics::NewProp_ShapeBodySetup = { UE4CodeGen_Private::EPropertyClass::Object, "ShapeBodySetup", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000202000, 1, nullptr, STRUCT_OFFSET(UShapeComponent, ShapeBodySetup), Z_Construct_UClass_UBodySetup_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UShapeComponent_Statics::NewProp_ShapeBodySetup_MetaData, ARRAY_COUNT(Z_Construct_UClass_UShapeComponent_Statics::NewProp_ShapeBodySetup_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UShapeComponent_Statics::ClassParams = {
		...
		0x00B010A5u,
		nullptr, 0,
		Z_Construct_UClass_UShapeComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UShapeComponent_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UShapeComponent, 2126529067);
