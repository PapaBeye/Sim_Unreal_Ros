...
static struct FScriptStruct_Engine_StaticRegisterNativesFKShapeElem
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bContributeToMass = { UE4CodeGen_Private::EPropertyClass::Bool, "bContributeToMass", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FKShapeElem), &Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bContributeToMass_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bContributeToMass_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bContributeToMass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_Name = { UE4CodeGen_Private::EPropertyClass::Name, "Name", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000001, 1, nullptr, STRUCT_OFFSET(FKShapeElem, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_Name_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_RestOffset = { UE4CodeGen_Private::EPropertyClass::Float, "RestOffset", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FKShapeElem, RestOffset), METADATA_PARAMS(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_RestOffset_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_RestOffset_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FKShapeElem_Statics::ReturnStructParams = {
		...
		sizeof(FKShapeElem),
		alignof(FKShapeElem),
		Z_Construct_UScriptStruct_FKShapeElem_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FKShapeElem_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FKShapeElem_CRC() { return 363296892U; }
