...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULocalPlayer_Statics::NewProp_bSentSplitJoin = { UE4CodeGen_Private::EPropertyClass::Bool, "bSentSplitJoin", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000022001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(ULocalPlayer), &Z_Construct_UClass_ULocalPlayer_Statics::NewProp_bSentSplitJoin_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_bSentSplitJoin_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_bSentSplitJoin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_ULocalPlayer_Statics::NewProp_PendingLevelPlayerControllerClass = { UE4CodeGen_Private::EPropertyClass::Class, "PendingLevelPlayerControllerClass", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0014000000000000, 1, nullptr, STRUCT_OFFSET(ULocalPlayer, PendingLevelPlayerControllerClass), Z_Construct_UClass_APlayerController_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_PendingLevelPlayerControllerClass_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_PendingLevelPlayerControllerClass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULocalPlayer_Statics::NewProp_AspectRatioAxisConstraint = { UE4CodeGen_Private::EPropertyClass::Byte, "AspectRatioAxisConstraint", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, STRUCT_OFFSET(ULocalPlayer, AspectRatioAxisConstraint), Z_Construct_UEnum_Engine_EAspectRatioAxisConstraint, METADATA_PARAMS(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_AspectRatioAxisConstraint_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_AspectRatioAxisConstraint_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULocalPlayer_Statics::NewProp_ViewportClient = { UE4CodeGen_Private::EPropertyClass::Object, "ViewportClient", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(ULocalPlayer, ViewportClient), Z_Construct_UClass_UGameViewportClient_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_ViewportClient_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_ViewportClient_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULocalPlayer_Statics::ClassParams = {
		...
		0x001000ACu,
		nullptr, 0,
		Z_Construct_UClass_ULocalPlayer_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_ULocalPlayer_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(ULocalPlayer, 3415480560);
