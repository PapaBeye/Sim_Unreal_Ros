...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars = { UE4CodeGen_Private::EPropertyClass::Array, "CVars", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004001, 1, nullptr, STRUCT_OFFSET(UDeviceProfile, CVars), METADATA_PARAMS(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars_MetaData)) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars_Inner = { UE4CodeGen_Private::EPropertyClass::Str, "CVars", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000004000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_Parent = { UE4CodeGen_Private::EPropertyClass::Object, "Parent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UDeviceProfile, Parent), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_Parent_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_Parent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_BaseProfileName = { UE4CodeGen_Private::EPropertyClass::Str, "BaseProfileName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004001, 1, nullptr, STRUCT_OFFSET(UDeviceProfile, BaseProfileName), METADATA_PARAMS(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_BaseProfileName_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_BaseProfileName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_DeviceType = { UE4CodeGen_Private::EPropertyClass::Str, "DeviceType", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000024001, 1, nullptr, STRUCT_OFFSET(UDeviceProfile, DeviceType), METADATA_PARAMS(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_DeviceType_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_DeviceType_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDeviceProfile_Statics::ClassParams = {
		...
		0x001004A4u,
		nullptr, 0,
		Z_Construct_UClass_UDeviceProfile_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::PropPointers),
		"DeviceProfiles",
	...
	IMPLEMENT_CLASS(UDeviceProfile, 1091701433);
