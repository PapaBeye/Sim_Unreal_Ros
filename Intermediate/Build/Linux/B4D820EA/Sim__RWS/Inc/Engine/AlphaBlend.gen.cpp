...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EAlphaBlendOption_CRC() { return 1949047130U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAlphaBlend
{
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAlphaBlend_Statics::NewProp_BlendTime = { UE4CodeGen_Private::EPropertyClass::Float, "BlendTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000001, 1, nullptr, STRUCT_OFFSET(FAlphaBlend, BlendTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FAlphaBlend_Statics::NewProp_BlendTime_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAlphaBlend_Statics::NewProp_BlendTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAlphaBlend_Statics::NewProp_BlendOption = { UE4CodeGen_Private::EPropertyClass::Enum, "BlendOption", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000001, 1, nullptr, STRUCT_OFFSET(FAlphaBlend, BlendOption), Z_Construct_UEnum_Engine_EAlphaBlendOption, METADATA_PARAMS(Z_Construct_UScriptStruct_FAlphaBlend_Statics::NewProp_BlendOption_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAlphaBlend_Statics::NewProp_BlendOption_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAlphaBlend_Statics::NewProp_BlendOption_Underlying = { UE4CodeGen_Private::EPropertyClass::Byte, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAlphaBlend_Statics::ReturnStructParams = {
		...
		sizeof(FAlphaBlend),
		alignof(FAlphaBlend),
		Z_Construct_UScriptStruct_FAlphaBlend_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FAlphaBlend_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FAlphaBlend_CRC() { return 3703705739U; }
