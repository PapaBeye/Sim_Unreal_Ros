...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_bLooping = { UE4CodeGen_Private::EPropertyClass::Bool, "bLooping", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(USoundNodeWavePlayer), &Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_bLooping_SetBit, METADATA_PARAMS(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_bLooping_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_bLooping_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWave_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Sound/SoundNodeWavePlayer.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWave = { UE4CodeGen_Private::EPropertyClass::Object, "SoundWave", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000002000, 1, nullptr, STRUCT_OFFSET(USoundNodeWavePlayer, SoundWave), Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWave_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWave_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWaveAssetPtr = { UE4CodeGen_Private::EPropertyClass::SoftObject, "SoundWaveAssetPtr", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0044000000000001, 1, nullptr, STRUCT_OFFSET(USoundNodeWavePlayer, SoundWaveAssetPtr), Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWaveAssetPtr_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWaveAssetPtr_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USoundNodeWavePlayer_Statics::ClassParams = {
		...
		0x000810A0u,
		nullptr, 0,
		Z_Construct_UClass_USoundNodeWavePlayer_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USoundNodeWavePlayer_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(USoundNodeWavePlayer, 3506014714);
