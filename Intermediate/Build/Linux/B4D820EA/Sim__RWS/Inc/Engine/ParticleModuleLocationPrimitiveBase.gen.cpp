...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_StartLocation = { UE4CodeGen_Private::EPropertyClass::Struct, "StartLocation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleLocationPrimitiveBase, StartLocation), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_StartLocation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_StartLocation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_VelocityScale = { UE4CodeGen_Private::EPropertyClass::Struct, "VelocityScale", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleLocationPrimitiveBase, VelocityScale), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_VelocityScale_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_VelocityScale_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_Positive_Z = { UE4CodeGen_Private::EPropertyClass::Bool, "Positive_Z", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleLocationPrimitiveBase), &Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_Positive_Z_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_Positive_Z_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_Positive_Z_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_Positive_Y = { UE4CodeGen_Private::EPropertyClass::Bool, "Positive_Y", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleLocationPrimitiveBase), &Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_Positive_Y_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_Positive_Y_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::NewProp_Positive_Y_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::ClassParams = {
		...
		0x009010A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationPrimitiveBase_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleLocationPrimitiveBase, 837898822);
