...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_StartingFrame = { UE4CodeGen_Private::EPropertyClass::Int, "StartingFrame", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleSubUVMovie, StartingFrame), METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_StartingFrame_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_StartingFrame_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_FrameRate = { UE4CodeGen_Private::EPropertyClass::Struct, "FrameRate", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010008000000001, 1, nullptr, STRUCT_OFFSET(UParticleModuleSubUVMovie, FrameRate), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_FrameRate_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_FrameRate_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_bUseEmitterTime = { UE4CodeGen_Private::EPropertyClass::Bool, "bUseEmitterTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleSubUVMovie), &Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_bUseEmitterTime_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_bUseEmitterTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::NewProp_bUseEmitterTime_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::ClassParams = {
		...
		0x008010A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSubUVMovie_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleSubUVMovie, 413430987);
