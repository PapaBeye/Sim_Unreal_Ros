...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USpectatorPawnMovement_Statics::NewProp_bIgnoreTimeDilation = { UE4CodeGen_Private::EPropertyClass::Bool, "bIgnoreTimeDilation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(USpectatorPawnMovement), &Z_Construct_UClass_USpectatorPawnMovement_Statics::NewProp_bIgnoreTimeDilation_SetBit, METADATA_PARAMS(Z_Construct_UClass_USpectatorPawnMovement_Statics::NewProp_bIgnoreTimeDilation_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpectatorPawnMovement_Statics::NewProp_bIgnoreTimeDilation_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpectatorPawnMovement_Statics::ClassParams = {
		...
		0x00B000A4u,
		nullptr, 0,
		Z_Construct_UClass_USpectatorPawnMovement_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USpectatorPawnMovement_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(USpectatorPawnMovement, 20269596);
