...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bApplyPSysScale = { UE4CodeGen_Private::EPropertyClass::Bool, "bApplyPSysScale", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleKillHeight), &Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bApplyPSysScale_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bApplyPSysScale_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bApplyPSysScale_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bFloor = { UE4CodeGen_Private::EPropertyClass::Bool, "bFloor", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleKillHeight), &Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bFloor_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bFloor_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bFloor_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bAbsolute = { UE4CodeGen_Private::EPropertyClass::Bool, "bAbsolute", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleKillHeight), &Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bAbsolute_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bAbsolute_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bAbsolute_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleKillHeight_Statics::ClassParams = {
		...
		0x008010A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleKillHeight_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillHeight_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleKillHeight, 447269799);
