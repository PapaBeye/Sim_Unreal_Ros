...
static struct FScriptStruct_Engine_StaticRegisterNativesFSingleAnimationPlayData
{
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPlayRate = { UE4CodeGen_Private::EPropertyClass::Float, "SavedPlayRate", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010040000000005, 1, nullptr, STRUCT_OFFSET(FSingleAnimationPlayData, SavedPlayRate), METADATA_PARAMS(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPlayRate_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPlayRate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPosition = { UE4CodeGen_Private::EPropertyClass::Float, "SavedPosition", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FSingleAnimationPlayData, SavedPosition), METADATA_PARAMS(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPosition_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPosition_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_bSavedPlaying = { UE4CodeGen_Private::EPropertyClass::Bool, "bSavedPlaying", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSingleAnimationPlayData), &Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_bSavedPlaying_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_bSavedPlaying_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_bSavedPlaying_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_AnimToPlay = { UE4CodeGen_Private::EPropertyClass::Object, "AnimToPlay", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FSingleAnimationPlayData, AnimToPlay), Z_Construct_UClass_UAnimationAsset_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_AnimToPlay_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_AnimToPlay_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FSingleAnimationPlayData_CRC() { return 3519523357U; }
