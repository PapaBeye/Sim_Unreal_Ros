...
static struct FScriptStruct_Engine_StaticRegisterNativesFMemberReference
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bWasDeprecated = { UE4CodeGen_Private::EPropertyClass::Bool, "bWasDeprecated", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FMemberReference), &Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bWasDeprecated_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bWasDeprecated_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bWasDeprecated_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext = { UE4CodeGen_Private::EPropertyClass::Bool, "bSelfContext", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FMemberReference), &Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberGuid = { UE4CodeGen_Private::EPropertyClass::Struct, "MemberGuid", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000000, 1, nullptr, STRUCT_OFFSET(FMemberReference, MemberGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberGuid_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberGuid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberScope = { UE4CodeGen_Private::EPropertyClass::Str, "MemberScope", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000000, 1, nullptr, STRUCT_OFFSET(FMemberReference, MemberScope), METADATA_PARAMS(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberScope_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberScope_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMemberReference_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMemberReference_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FMemberReference_CRC() { return 348176683U; }
