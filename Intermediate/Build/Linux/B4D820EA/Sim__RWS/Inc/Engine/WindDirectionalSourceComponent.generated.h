...
private: \
	...
	ENGINE_API UWindDirectionalSourceComponent(UWindDirectionalSourceComponent&&); \
	ENGINE_API UWindDirectionalSourceComponent(const UWindDirectionalSourceComponent&); \
public:


#define Engine_Source_Runtime_Engine_Classes_Components_WindDirectionalSourceComponent_h_25_ENHANCED_CONSTRUCTORS \
	/** Standard constructor, called after all reflected properties have been initialized */ \
	ENGINE_API UWindDirectionalSourceComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()) : Super(ObjectInitializer) { }; \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	ENGINE_API UWindDirectionalSourceComponent(UWindDirectionalSourceComponent&&); \
	ENGINE_API UWindDirectionalSourceComponent(const UWindDirectionalSourceComponent&); \
