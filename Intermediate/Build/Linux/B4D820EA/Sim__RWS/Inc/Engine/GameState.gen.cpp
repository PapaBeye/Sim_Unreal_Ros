...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AGameState_OnRep_ElapsedTime_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGameState, "OnRep_ElapsedTime", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00020400, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AGameState_OnRep_ElapsedTime_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AGameState_OnRep_ElapsedTime_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AGameState_OnRep_MatchState_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGameState, "OnRep_MatchState", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00020400, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AGameState_OnRep_MatchState_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AGameState_OnRep_MatchState_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AGameState_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AGameState_OnRep_ElapsedTime, "OnRep_ElapsedTime" }, // 2713718882
		{ &Z_Construct_UFunction_AGameState_OnRep_MatchState, "OnRep_MatchState" }, // 2331787168
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AGameState_Statics::NewProp_ElapsedTime = { UE4CodeGen_Private::EPropertyClass::Int, "ElapsedTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000100000034, 1, "OnRep_ElapsedTime", STRUCT_OFFSET(AGameState, ElapsedTime), METADATA_PARAMS(Z_Construct_UClass_AGameState_Statics::NewProp_ElapsedTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGameState_Statics::NewProp_ElapsedTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_AGameState_Statics::NewProp_PreviousMatchState = { UE4CodeGen_Private::EPropertyClass::Name, "PreviousMatchState", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000020815, 1, nullptr, STRUCT_OFFSET(AGameState, PreviousMatchState), METADATA_PARAMS(Z_Construct_UClass_AGameState_Statics::NewProp_PreviousMatchState_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGameState_Statics::NewProp_PreviousMatchState_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_AGameState_Statics::NewProp_MatchState = { UE4CodeGen_Private::EPropertyClass::Name, "MatchState", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080100020835, 1, "OnRep_MatchState", STRUCT_OFFSET(AGameState, MatchState), METADATA_PARAMS(Z_Construct_UClass_AGameState_Statics::NewProp_MatchState_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGameState_Statics::NewProp_MatchState_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AGameState_Statics::ClassParams = {
		...
		Z_Construct_UClass_AGameState_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AGameState_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(AGameState, 764964981);
