...
static struct FScriptStruct_Engine_StaticRegisterNativesFAssetImportInfo
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FAssetImportInfo_CRC() { return 1235828981U; }
...
#if WITH_EDITORONLY_DATA
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAssetImportData_K2_ExtractFilenames_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Array, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000800000580, 1, nullptr, STRUCT_OFFSET(AssetImportData_eventK2_ExtractFilenames_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UAssetImportData_K2_ExtractFilenames_Statics::NewProp_ReturnValue_Inner = { UE4CodeGen_Private::EPropertyClass::Str, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000800000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_EDITORONLY_DATA
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UAssetImportData_K2_GetFirstFilename_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Str, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000800000580, 1, nullptr, STRUCT_OFFSET(AssetImportData_eventK2_GetFirstFilename_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAssetImportData_K2_ExtractFilenames, "K2_ExtractFilenames" }, // 3040466587
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAssetImportData_K2_GetFirstFilename, "K2_GetFirstFilename" }, // 2450313488
#endif //WITH_EDITOR
	};
#endif //WITH_EDITOR
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAssetImportData_Statics::NewProp_SourceData = { UE4CodeGen_Private::EPropertyClass::Struct, "SourceData", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000800020001, 1, nullptr, STRUCT_OFFSET(UAssetImportData, SourceData), Z_Construct_UScriptStruct_FAssetImportInfo, METADATA_PARAMS(Z_Construct_UClass_UAssetImportData_Statics::NewProp_SourceData_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAssetImportData_Statics::NewProp_SourceData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAssetImportData_Statics::NewProp_SourceFileTimestamp = { UE4CodeGen_Private::EPropertyClass::Str, "SourceFileTimestamp", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000820000000, 1, nullptr, STRUCT_OFFSET(UAssetImportData, SourceFileTimestamp_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_UAssetImportData_Statics::NewProp_SourceFileTimestamp_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAssetImportData_Statics::NewProp_SourceFileTimestamp_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAssetImportData_Statics::NewProp_SourceFilePath = { UE4CodeGen_Private::EPropertyClass::Str, "SourceFilePath", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000820000000, 1, nullptr, STRUCT_OFFSET(UAssetImportData, SourceFilePath_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_UAssetImportData_Statics::NewProp_SourceFilePath_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAssetImportData_Statics::NewProp_SourceFilePath_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAssetImportData_Statics::ClassParams = {
		...
		IF_WITH_EDITORONLY_DATA(Z_Construct_UClass_UAssetImportData_Statics::PropPointers, nullptr), IF_WITH_EDITORONLY_DATA(ARRAY_COUNT(Z_Construct_UClass_UAssetImportData_Statics::PropPointers), 0),
		nullptr,
	...
	IMPLEMENT_CLASS(UAssetImportData, 1230670641);
