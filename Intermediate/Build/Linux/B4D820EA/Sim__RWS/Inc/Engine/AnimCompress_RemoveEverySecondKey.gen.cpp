...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_bStartAtSecondKey = { UE4CodeGen_Private::EPropertyClass::Bool, "bStartAtSecondKey", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UAnimCompress_RemoveEverySecondKey), &Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_bStartAtSecondKey_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_bStartAtSecondKey_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_bStartAtSecondKey_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_MinKeys = { UE4CodeGen_Private::EPropertyClass::Int, "MinKeys", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UAnimCompress_RemoveEverySecondKey, MinKeys), METADATA_PARAMS(Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_MinKeys_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_MinKeys_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::ClassParams = {
		...
		0x000810A0u,
		nullptr, 0,
		Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UAnimCompress_RemoveEverySecondKey, 1130850647);
