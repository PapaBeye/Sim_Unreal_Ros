...
class UScriptStruct* FHLODProxyMesh::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ENGINE_API uint32 Get_Z_Construct_UScriptStruct_FHLODProxyMesh_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FHLODProxyMesh, Z_Construct_UPackage__Script_Engine(), TEXT("HLODProxyMesh"), sizeof(FHLODProxyMesh), Get_Z_Construct_UScriptStruct_FHLODProxyMesh_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFHLODProxyMesh
{
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_Key = { UE4CodeGen_Private::EPropertyClass::Name, "Key", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000020001, 1, nullptr, STRUCT_OFFSET(FHLODProxyMesh, Key), METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_Key_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_Key_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_StaticMesh = { UE4CodeGen_Private::EPropertyClass::Object, "StaticMesh", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000020001, 1, nullptr, STRUCT_OFFSET(FHLODProxyMesh, StaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_StaticMesh_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_StaticMesh_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FLazyObjectPropertyParams Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_LODActor = { UE4CodeGen_Private::EPropertyClass::LazyObject, "LODActor", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0044000000020001, 1, nullptr, STRUCT_OFFSET(FHLODProxyMesh, LODActor), Z_Construct_UClass_ALODActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_LODActor_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_LODActor_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FHLODProxyMesh_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("HLODProxyMesh"), sizeof(FHLODProxyMesh), Get_Z_Construct_UScriptStruct_FHLODProxyMesh_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FHLODProxyMesh_CRC() { return 663228720U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHLODProxy_Statics::NewProp_ProxyMeshes = { UE4CodeGen_Private::EPropertyClass::Array, "ProxyMeshes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000020001, 1, nullptr, STRUCT_OFFSET(UHLODProxy, ProxyMeshes), METADATA_PARAMS(Z_Construct_UClass_UHLODProxy_Statics::NewProp_ProxyMeshes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UHLODProxy_Statics::NewProp_ProxyMeshes_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHLODProxy_Statics::NewProp_ProxyMeshes_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "ProxyMeshes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000020000, 1, nullptr, 0, Z_Construct_UScriptStruct_FHLODProxyMesh, METADATA_PARAMS(nullptr, 0) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UHLODProxy_Statics::ClassParams = {
		...
		0x001000A0u,
		nullptr, 0,
		Z_Construct_UClass_UHLODProxy_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UHLODProxy_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UHLODProxy, 3569931569);
