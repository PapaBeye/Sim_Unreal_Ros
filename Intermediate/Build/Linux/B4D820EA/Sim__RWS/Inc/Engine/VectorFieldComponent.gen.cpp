...
// End Cross Module References
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UVectorFieldComponent_SetIntensity_Statics::NewProp_NewIntensity = { UE4CodeGen_Private::EPropertyClass::Float, "NewIntensity", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(VectorFieldComponent_eventSetIntensity_Parms, NewIntensity), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UVectorFieldComponent_SetIntensity_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVectorFieldComponent, "SetIntensity", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020400, sizeof(VectorFieldComponent_eventSetIntensity_Parms), Z_Construct_UFunction_UVectorFieldComponent_SetIntensity_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UVectorFieldComponent_SetIntensity_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UVectorFieldComponent_SetIntensity_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UVectorFieldComponent_SetIntensity_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVectorFieldComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVectorFieldComponent_SetIntensity, "SetIntensity" }, // 1864846267
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_bPreviewVectorField = { UE4CodeGen_Private::EPropertyClass::Bool, "bPreviewVectorField", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000002000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UVectorFieldComponent), &Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_bPreviewVectorField_SetBit, METADATA_PARAMS(Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_bPreviewVectorField_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_bPreviewVectorField_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_Tightness = { UE4CodeGen_Private::EPropertyClass::Float, "Tightness", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UVectorFieldComponent, Tightness), METADATA_PARAMS(Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_Tightness_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_Tightness_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_Intensity = { UE4CodeGen_Private::EPropertyClass::Float, "Intensity", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000200000005, 1, nullptr, STRUCT_OFFSET(UVectorFieldComponent, Intensity), METADATA_PARAMS(Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_Intensity_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_Intensity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_VectorField = { UE4CodeGen_Private::EPropertyClass::Object, "VectorField", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UVectorFieldComponent, VectorField), Z_Construct_UClass_UVectorField_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_VectorField_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVectorFieldComponent_Statics::NewProp_VectorField_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVectorFieldComponent_Statics::ClassParams = {
		...
		Z_Construct_UClass_UVectorFieldComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UVectorFieldComponent_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UVectorFieldComponent, 424601511);
