...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EParticleSystemInsignificanceReaction_CRC() { return 1399781633U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EParticleSignificanceLevel_CRC() { return 3969831848U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EParticleDetailMode_CRC() { return 2151153609U; }
	UEnum* Z_Construct_UEnum_Engine_EParticleDetailMode()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EParticleDetailMode"), 0, Get_Z_Construct_UEnum_Engine_EParticleDetailMode_CRC(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
