...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBrushComponent_Statics::NewProp_PrePivot = { UE4CodeGen_Private::EPropertyClass::Struct, "PrePivot", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000820000000, 1, nullptr, STRUCT_OFFSET(UBrushComponent, PrePivot_DEPRECATED), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UBrushComponent_Statics::NewProp_PrePivot_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBrushComponent_Statics::NewProp_PrePivot_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBrushComponent_Statics::NewProp_BrushBodySetup = { UE4CodeGen_Private::EPropertyClass::Object, "BrushBodySetup", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UBrushComponent, BrushBodySetup), Z_Construct_UClass_UBodySetup_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBrushComponent_Statics::NewProp_BrushBodySetup_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBrushComponent_Statics::NewProp_BrushBodySetup_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBrushComponent_Statics::NewProp_Brush_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Components/BrushComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBrushComponent_Statics::NewProp_Brush = { UE4CodeGen_Private::EPropertyClass::Object, "Brush", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UBrushComponent, Brush), Z_Construct_UClass_UModel, METADATA_PARAMS(Z_Construct_UClass_UBrushComponent_Statics::NewProp_Brush_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBrushComponent_Statics::NewProp_Brush_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBrushComponent_Statics::ClassParams = {
		...
		0x00A810A4u,
		nullptr, 0,
		Z_Construct_UClass_UBrushComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UBrushComponent_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UBrushComponent, 3331832950);
