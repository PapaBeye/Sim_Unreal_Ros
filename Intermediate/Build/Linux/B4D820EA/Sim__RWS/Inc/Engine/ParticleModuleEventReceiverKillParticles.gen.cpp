...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleEventReceiverKillParticles_Statics::NewProp_bStopSpawning = { UE4CodeGen_Private::EPropertyClass::Bool, "bStopSpawning", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleModuleEventReceiverKillParticles), &Z_Construct_UClass_UParticleModuleEventReceiverKillParticles_Statics::NewProp_bStopSpawning_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleEventReceiverKillParticles_Statics::NewProp_bStopSpawning_MetaData, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleEventReceiverKillParticles_Statics::NewProp_bStopSpawning_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleEventReceiverKillParticles_Statics::ClassParams = {
		...
		0x000010A0u,
		nullptr, 0,
		Z_Construct_UClass_UParticleModuleEventReceiverKillParticles_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleEventReceiverKillParticles_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UParticleModuleEventReceiverKillParticles, 543371533);
