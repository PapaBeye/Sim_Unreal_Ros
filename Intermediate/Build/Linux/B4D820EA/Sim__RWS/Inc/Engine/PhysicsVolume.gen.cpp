...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact = { UE4CodeGen_Private::EPropertyClass::Bool, "bPhysicsOnContact", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(APhysicsVolume), &Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact_SetBit, METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact_MetaData, ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bWaterVolume = { UE4CodeGen_Private::EPropertyClass::Bool, "bWaterVolume", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(APhysicsVolume), &Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bWaterVolume_SetBit, METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bWaterVolume_MetaData, ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bWaterVolume_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_FluidFriction = { UE4CodeGen_Private::EPropertyClass::Float, "FluidFriction", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(APhysicsVolume, FluidFriction), METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_FluidFriction_MetaData, ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_FluidFriction_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_Priority = { UE4CodeGen_Private::EPropertyClass::Int, "Priority", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(APhysicsVolume, Priority), METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_Priority_MetaData, ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_Priority_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_TerminalVelocity = { UE4CodeGen_Private::EPropertyClass::Float, "TerminalVelocity", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(APhysicsVolume, TerminalVelocity), METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_TerminalVelocity_MetaData, ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_TerminalVelocity_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APhysicsVolume_Statics::ClassParams = {
		...
		0x009000A0u,
		nullptr, 0,
		Z_Construct_UClass_APhysicsVolume_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(APhysicsVolume, 1295543964);
