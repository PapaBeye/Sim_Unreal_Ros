...
// End Cross Module References
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ASpotLight_SetInnerConeAngle_Statics::NewProp_NewInnerConeAngle = { UE4CodeGen_Private::EPropertyClass::Float, "NewInnerConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(SpotLight_eventSetInnerConeAngle_Parms, NewInnerConeAngle), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ASpotLight_SetOuterConeAngle_Statics::NewProp_NewOuterConeAngle = { UE4CodeGen_Private::EPropertyClass::Float, "NewOuterConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(SpotLight_eventSetOuterConeAngle_Parms, NewOuterConeAngle), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASpotLight_SetOuterConeAngle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASpotLight, "SetOuterConeAngle", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(SpotLight_eventSetOuterConeAngle_Parms), Z_Construct_UFunction_ASpotLight_SetOuterConeAngle_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ASpotLight_SetOuterConeAngle_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASpotLight_SetOuterConeAngle_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ASpotLight_SetOuterConeAngle_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASpotLight_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASpotLight_SetInnerConeAngle, "SetInnerConeAngle" }, // 1050820891
		{ &Z_Construct_UFunction_ASpotLight_SetOuterConeAngle, "SetOuterConeAngle" }, // 852892658
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASpotLight_Statics::NewProp_SpotLightComponent = { UE4CodeGen_Private::EPropertyClass::Object, "SpotLightComponent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x001000000008001c, 1, nullptr, STRUCT_OFFSET(ASpotLight, SpotLightComponent), Z_Construct_UClass_USpotLightComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASpotLight_Statics::NewProp_SpotLightComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_ASpotLight_Statics::NewProp_SpotLightComponent_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ASpotLight_Statics::ClassParams = {
		...
		Z_Construct_UClass_ASpotLight_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_ASpotLight_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(ASpotLight, 3194922265);
