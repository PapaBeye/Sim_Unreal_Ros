...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors = { UE4CodeGen_Private::EPropertyClass::Array, "Actors", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000002000, 1, nullptr, STRUCT_OFFSET(ULevelActorContainer, Actors), METADATA_PARAMS(Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "Actors", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULevelActorContainer_Statics::ClassParams = {
		...
		0x002800A0u,
		nullptr, 0,
		Z_Construct_UClass_ULevelActorContainer_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_ULevelActorContainer_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(ULevelActorContainer, 4243479561);
