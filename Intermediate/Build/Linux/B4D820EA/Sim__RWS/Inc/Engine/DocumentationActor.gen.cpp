...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_ADocumentationActor_Statics::NewProp_DocumentLink = { UE4CodeGen_Private::EPropertyClass::Str, "DocumentLink", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010040800000005, 1, nullptr, STRUCT_OFFSET(ADocumentationActor, DocumentLink), METADATA_PARAMS(Z_Construct_UClass_ADocumentationActor_Statics::NewProp_DocumentLink_MetaData, ARRAY_COUNT(Z_Construct_UClass_ADocumentationActor_Statics::NewProp_DocumentLink_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ADocumentationActor_Statics::ClassParams = {
		...
		0x009000A0u,
		nullptr, 0,
		IF_WITH_EDITORONLY_DATA(Z_Construct_UClass_ADocumentationActor_Statics::PropPointers, nullptr), IF_WITH_EDITORONLY_DATA(ARRAY_COUNT(Z_Construct_UClass_ADocumentationActor_Statics::PropPointers), 0),
		nullptr,
	...
	IMPLEMENT_CLASS(ADocumentationActor, 1610052393);
