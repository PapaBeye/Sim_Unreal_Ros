...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewCaptureBox = { UE4CodeGen_Private::EPropertyClass::Object, "PreviewCaptureBox", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000080008, 1, nullptr, STRUCT_OFFSET(UBoxReflectionCaptureComponent, PreviewCaptureBox), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewCaptureBox_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewCaptureBox_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewInfluenceBox = { UE4CodeGen_Private::EPropertyClass::Object, "PreviewInfluenceBox", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000080008, 1, nullptr, STRUCT_OFFSET(UBoxReflectionCaptureComponent, PreviewInfluenceBox), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewInfluenceBox_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewInfluenceBox_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_BoxTransitionDistance = { UE4CodeGen_Private::EPropertyClass::Float, "BoxTransitionDistance", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UBoxReflectionCaptureComponent, BoxTransitionDistance), METADATA_PARAMS(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_BoxTransitionDistance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_BoxTransitionDistance_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::ClassParams = {
		...
		0x00A800A4u,
		nullptr, 0,
		Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UBoxReflectionCaptureComponent, 3344464053);
