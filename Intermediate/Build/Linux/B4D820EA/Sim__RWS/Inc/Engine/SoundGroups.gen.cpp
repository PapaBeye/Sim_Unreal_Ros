...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ESoundGroup_CRC() { return 3135383487U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundGroup
{
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_DecompressedDuration = { UE4CodeGen_Private::EPropertyClass::Float, "DecompressedDuration", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, STRUCT_OFFSET(FSoundGroup, DecompressedDuration), METADATA_PARAMS(Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_DecompressedDuration_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_DecompressedDuration_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_bAlwaysDecompressOnLoad = { UE4CodeGen_Private::EPropertyClass::Bool, "bAlwaysDecompressOnLoad", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSoundGroup), &Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_bAlwaysDecompressOnLoad_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_bAlwaysDecompressOnLoad_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_bAlwaysDecompressOnLoad_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_DisplayName = { UE4CodeGen_Private::EPropertyClass::Str, "DisplayName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, STRUCT_OFFSET(FSoundGroup, DisplayName), METADATA_PARAMS(Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_DisplayName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_DisplayName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_SoundGroup = { UE4CodeGen_Private::EPropertyClass::Byte, "SoundGroup", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004000, 1, nullptr, STRUCT_OFFSET(FSoundGroup, SoundGroup), Z_Construct_UEnum_Engine_ESoundGroup, METADATA_PARAMS(Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_SoundGroup_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundGroup_Statics::NewProp_SoundGroup_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSoundGroup_Statics::ReturnStructParams = {
		...
		sizeof(FSoundGroup),
		alignof(FSoundGroup),
		Z_Construct_UScriptStruct_FSoundGroup_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundGroup_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FSoundGroup_CRC() { return 3336889503U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USoundGroups_Statics::NewProp_SoundGroupProfiles = { UE4CodeGen_Private::EPropertyClass::Array, "SoundGroupProfiles", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000004000, 1, nullptr, STRUCT_OFFSET(USoundGroups, SoundGroupProfiles), METADATA_PARAMS(Z_Construct_UClass_USoundGroups_Statics::NewProp_SoundGroupProfiles_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundGroups_Statics::NewProp_SoundGroupProfiles_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundGroups_Statics::NewProp_SoundGroupProfiles_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "SoundGroupProfiles", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000004000, 1, nullptr, 0, Z_Construct_UScriptStruct_FSoundGroup, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USoundGroups_Statics::ClassParams = {
		...
		0x000000A5u,
		nullptr, 0,
		Z_Construct_UClass_USoundGroups_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USoundGroups_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(USoundGroups, 1070223709);
