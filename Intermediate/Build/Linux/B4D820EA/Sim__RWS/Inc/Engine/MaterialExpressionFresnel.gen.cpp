...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_Normal = { UE4CodeGen_Private::EPropertyClass::Struct, "Normal", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionFresnel, Normal), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_Normal_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_Normal_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_BaseReflectFractionIn = { UE4CodeGen_Private::EPropertyClass::Struct, "BaseReflectFractionIn", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionFresnel, BaseReflectFractionIn), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_BaseReflectFractionIn_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_BaseReflectFractionIn_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_Exponent = { UE4CodeGen_Private::EPropertyClass::Float, "Exponent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionFresnel, Exponent), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_Exponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_Exponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_ExponentIn = { UE4CodeGen_Private::EPropertyClass::Struct, "ExponentIn", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionFresnel, ExponentIn), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_ExponentIn_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_ExponentIn_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionFresnel_Statics::ClassParams = {
		...
		0x000820A0u,
		nullptr, 0,
		Z_Construct_UClass_UMaterialExpressionFresnel_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMaterialExpressionFresnel, 2663631614);
