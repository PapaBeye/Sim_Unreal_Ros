...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_G = { UE4CodeGen_Private::EPropertyClass::Float, "G", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionConstant2Vector, G), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_G_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_G_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_R = { UE4CodeGen_Private::EPropertyClass::Float, "R", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionConstant2Vector, R), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_R_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_R_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::ClassParams = {
		...
		0x000820A0u,
		nullptr, 0,
		Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMaterialExpressionConstant2Vector, 691370286);
