...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_USoundNodeWaveParam_Statics::NewProp_WaveParameterName = { UE4CodeGen_Private::EPropertyClass::Name, "WaveParameterName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(USoundNodeWaveParam, WaveParameterName), METADATA_PARAMS(Z_Construct_UClass_USoundNodeWaveParam_Statics::NewProp_WaveParameterName_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundNodeWaveParam_Statics::NewProp_WaveParameterName_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USoundNodeWaveParam_Statics::ClassParams = {
		...
		0x000810A0u,
		nullptr, 0,
		Z_Construct_UClass_USoundNodeWaveParam_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USoundNodeWaveParam_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(USoundNodeWaveParam, 1712147009);
