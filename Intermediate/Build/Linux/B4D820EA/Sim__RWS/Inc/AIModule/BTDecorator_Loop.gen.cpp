...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_InfiniteLoopTimeoutTime = { UE4CodeGen_Private::EPropertyClass::Float, "InfiniteLoopTimeoutTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UBTDecorator_Loop, InfiniteLoopTimeoutTime), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_InfiniteLoopTimeoutTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_InfiniteLoopTimeoutTime_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_bInfiniteLoop = { UE4CodeGen_Private::EPropertyClass::Bool, "bInfiniteLoop", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UBTDecorator_Loop), &Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_bInfiniteLoop_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_bInfiniteLoop_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_bInfiniteLoop_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_NumLoops = { UE4CodeGen_Private::EPropertyClass::Int, "NumLoops", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UBTDecorator_Loop, NumLoops), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_NumLoops_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_NumLoops_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBTDecorator_Loop_Statics::ClassParams = {
		...
		0x001000A0u,
		nullptr, 0,
		Z_Construct_UClass_UBTDecorator_Loop_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Loop_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UBTDecorator_Loop, 3989136213);
