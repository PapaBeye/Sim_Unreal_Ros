...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UCrowdFollowingComponent_SuspendCrowdSteering_Statics::NewProp_bSuspend = { UE4CodeGen_Private::EPropertyClass::Bool, "bSuspend", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(CrowdFollowingComponent_eventSuspendCrowdSteering_Parms), &Z_Construct_UFunction_UCrowdFollowingComponent_SuspendCrowdSteering_Statics::NewProp_bSuspend_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCrowdFollowingComponent_SuspendCrowdSteering_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCrowdFollowingComponent, "SuspendCrowdSteering", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020400, sizeof(CrowdFollowingComponent_eventSuspendCrowdSteering_Parms), Z_Construct_UFunction_UCrowdFollowingComponent_SuspendCrowdSteering_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCrowdFollowingComponent_SuspendCrowdSteering_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCrowdFollowingComponent_SuspendCrowdSteering_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCrowdFollowingComponent_SuspendCrowdSteering_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCrowdFollowingComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCrowdFollowingComponent_SuspendCrowdSteering, "SuspendCrowdSteering" }, // 2755139941
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCrowdFollowingComponent_Statics::NewProp_GroupsToAvoid = { UE4CodeGen_Private::EPropertyClass::Struct, "GroupsToAvoid", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080820000000, 1, nullptr, STRUCT_OFFSET(UCrowdFollowingComponent, GroupsToAvoid_DEPRECATED), Z_Construct_UScriptStruct_FNavAvoidanceMask, METADATA_PARAMS(Z_Construct_UClass_UCrowdFollowingComponent_Statics::NewProp_GroupsToAvoid_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCrowdFollowingComponent_Statics::NewProp_GroupsToAvoid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCrowdFollowingComponent_Statics::NewProp_AvoidanceGroup = { UE4CodeGen_Private::EPropertyClass::Struct, "AvoidanceGroup", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080820000000, 1, nullptr, STRUCT_OFFSET(UCrowdFollowingComponent, AvoidanceGroup_DEPRECATED), Z_Construct_UScriptStruct_FNavAvoidanceMask, METADATA_PARAMS(Z_Construct_UClass_UCrowdFollowingComponent_Statics::NewProp_AvoidanceGroup_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCrowdFollowingComponent_Statics::NewProp_AvoidanceGroup_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCrowdFollowingComponent_Statics::NewProp_CrowdAgentMoveDirection = { UE4CodeGen_Private::EPropertyClass::Struct, "CrowdAgentMoveDirection", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UCrowdFollowingComponent, CrowdAgentMoveDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UCrowdFollowingComponent_Statics::NewProp_CrowdAgentMoveDirection_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCrowdFollowingComponent_Statics::NewProp_CrowdAgentMoveDirection_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UCrowdFollowingComponent_Statics::ClassParams = {
		...
		Z_Construct_UClass_UCrowdFollowingComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UCrowdFollowingComponent_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UCrowdFollowingComponent, 3968270039);
