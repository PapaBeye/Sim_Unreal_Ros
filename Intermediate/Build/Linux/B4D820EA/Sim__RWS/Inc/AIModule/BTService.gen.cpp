...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBTService_Statics::NewProp_bRestartTimerOnEachActivation = { UE4CodeGen_Private::EPropertyClass::Bool, "bRestartTimerOnEachActivation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00200c0000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UBTService), &Z_Construct_UClass_UBTService_Statics::NewProp_bRestartTimerOnEachActivation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBTService_Statics::NewProp_bRestartTimerOnEachActivation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBTService_Statics::NewProp_bRestartTimerOnEachActivation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTService_Statics::NewProp_RandomDeviation = { UE4CodeGen_Private::EPropertyClass::Float, "RandomDeviation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000001, 1, nullptr, STRUCT_OFFSET(UBTService, RandomDeviation), METADATA_PARAMS(Z_Construct_UClass_UBTService_Statics::NewProp_RandomDeviation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBTService_Statics::NewProp_RandomDeviation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTService_Statics::NewProp_Interval = { UE4CodeGen_Private::EPropertyClass::Float, "Interval", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000001, 1, nullptr, STRUCT_OFFSET(UBTService, Interval), METADATA_PARAMS(Z_Construct_UClass_UBTService_Statics::NewProp_Interval_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBTService_Statics::NewProp_Interval_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBTService_Statics::ClassParams = {
		...
		0x001000A1u,
		nullptr, 0,
		Z_Construct_UClass_UBTService_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UBTService_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UBTService, 3052016758);
