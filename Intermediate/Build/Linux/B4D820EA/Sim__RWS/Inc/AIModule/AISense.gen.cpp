...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAISense_Statics::NewProp_PerceptionSystemInstance = { UE4CodeGen_Private::EPropertyClass::Object, "PerceptionSystemInstance", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UAISense, PerceptionSystemInstance), Z_Construct_UClass_UAIPerceptionSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAISense_Statics::NewProp_PerceptionSystemInstance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Statics::NewProp_PerceptionSystemInstance_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAISense_Statics::NewProp_bAutoRegisterAllPawnsAsSources = { UE4CodeGen_Private::EPropertyClass::Bool, "bAutoRegisterAllPawnsAsSources", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000014015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UAISense), &Z_Construct_UClass_UAISense_Statics::NewProp_bAutoRegisterAllPawnsAsSources_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAISense_Statics::NewProp_bAutoRegisterAllPawnsAsSources_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Statics::NewProp_bAutoRegisterAllPawnsAsSources_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAISense_Statics::NewProp_bWantsNewPawnNotification = { UE4CodeGen_Private::EPropertyClass::Bool, "bWantsNewPawnNotification", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000014015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UAISense), &Z_Construct_UClass_UAISense_Statics::NewProp_bWantsNewPawnNotification_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAISense_Statics::NewProp_bWantsNewPawnNotification_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Statics::NewProp_bWantsNewPawnNotification_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAISense_Statics::NewProp_NotifyType = { UE4CodeGen_Private::EPropertyClass::Enum, "NotifyType", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000014015, 1, nullptr, STRUCT_OFFSET(UAISense, NotifyType), Z_Construct_UEnum_AIModule_EAISenseNotifyType, METADATA_PARAMS(Z_Construct_UClass_UAISense_Statics::NewProp_NotifyType_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Statics::NewProp_NotifyType_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAISense_Statics::NewProp_NotifyType_Underlying = { UE4CodeGen_Private::EPropertyClass::Byte, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISense_Statics::NewProp_DefaultExpirationAge = { UE4CodeGen_Private::EPropertyClass::Float, "DefaultExpirationAge", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000004015, 1, nullptr, STRUCT_OFFSET(UAISense, DefaultExpirationAge), METADATA_PARAMS(Z_Construct_UClass_UAISense_Statics::NewProp_DefaultExpirationAge_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Statics::NewProp_DefaultExpirationAge_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAISense_Statics::ClassParams = {
		...
		0x001000A5u,
		nullptr, 0,
		Z_Construct_UClass_UAISense_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UAISense_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UAISense, 626576718);
