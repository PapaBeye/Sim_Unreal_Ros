...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTTask_Wait_Statics::NewProp_RandomDeviation = { UE4CodeGen_Private::EPropertyClass::Float, "RandomDeviation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UBTTask_Wait, RandomDeviation), METADATA_PARAMS(Z_Construct_UClass_UBTTask_Wait_Statics::NewProp_RandomDeviation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBTTask_Wait_Statics::NewProp_RandomDeviation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTTask_Wait_Statics::NewProp_WaitTime = { UE4CodeGen_Private::EPropertyClass::Float, "WaitTime", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UBTTask_Wait, WaitTime), METADATA_PARAMS(Z_Construct_UClass_UBTTask_Wait_Statics::NewProp_WaitTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBTTask_Wait_Statics::NewProp_WaitTime_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBTTask_Wait_Statics::ClassParams = {
		...
		0x001000A0u,
		nullptr, 0,
		Z_Construct_UClass_UBTTask_Wait_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UBTTask_Wait_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UBTTask_Wait, 1271745470);
