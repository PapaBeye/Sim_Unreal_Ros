...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_bInteger = { UE4CodeGen_Private::EPropertyClass::Bool, "bInteger", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UAIDataProvider_Random), &Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_bInteger_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_bInteger_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_bInteger_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_Max = { UE4CodeGen_Private::EPropertyClass::Float, "Max", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000001, 1, nullptr, STRUCT_OFFSET(UAIDataProvider_Random, Max), METADATA_PARAMS(Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_Max_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_Max_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_Min = { UE4CodeGen_Private::EPropertyClass::Float, "Min", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000001, 1, nullptr, STRUCT_OFFSET(UAIDataProvider_Random, Min), METADATA_PARAMS(Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_Min_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAIDataProvider_Random_Statics::NewProp_Min_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAIDataProvider_Random_Statics::ClassParams = {
		...
		0x000030A0u,
		nullptr, 0,
		Z_Construct_UClass_UAIDataProvider_Random_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UAIDataProvider_Random_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UAIDataProvider_Random, 2749706200);
