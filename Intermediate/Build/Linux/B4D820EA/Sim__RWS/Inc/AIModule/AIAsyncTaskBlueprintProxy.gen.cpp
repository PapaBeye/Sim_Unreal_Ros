...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_AIModule_OAISimpleDelegate__DelegateSignature_Statics::NewProp_MovementResult = { UE4CodeGen_Private::EPropertyClass::Byte, "MovementResult", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(_Script_AIModule_eventOAISimpleDelegate_Parms, MovementResult), Z_Construct_UEnum_AIModule_EPathFollowingResult, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_AIModule_OAISimpleDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AIModule, "OAISimpleDelegate__DelegateSignature", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00130000, sizeof(_Script_AIModule_eventOAISimpleDelegate_Parms), Z_Construct_UDelegateFunction_AIModule_OAISimpleDelegate__DelegateSignature_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UDelegateFunction_AIModule_OAISimpleDelegate__DelegateSignature_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_AIModule_OAISimpleDelegate__DelegateSignature_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UDelegateFunction_AIModule_OAISimpleDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAIAsyncTaskBlueprintProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAIAsyncTaskBlueprintProxy_OnMoveCompleted, "OnMoveCompleted" }, // 3354502491
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAIAsyncTaskBlueprintProxy_Statics::NewProp_OnSuccess = { UE4CodeGen_Private::EPropertyClass::MulticastDelegate, "OnSuccess", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000010080000, 1, nullptr, STRUCT_OFFSET(UAIAsyncTaskBlueprintProxy, OnSuccess), Z_Construct_UDelegateFunction_AIModule_OAISimpleDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAIAsyncTaskBlueprintProxy_Statics::NewProp_OnSuccess_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAIAsyncTaskBlueprintProxy_Statics::NewProp_OnSuccess_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAIAsyncTaskBlueprintProxy_Statics::ClassParams = {
		...
		Z_Construct_UClass_UAIAsyncTaskBlueprintProxy_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UAIAsyncTaskBlueprintProxy_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UAIAsyncTaskBlueprintProxy, 244621708);
