...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_DetectionByAffiliation = { UE4CodeGen_Private::EPropertyClass::Struct, "DetectionByAffiliation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000014015, 1, nullptr, STRUCT_OFFSET(UAISenseConfig_Sight, DetectionByAffiliation), Z_Construct_UScriptStruct_FAISenseAffiliationFilter, METADATA_PARAMS(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_DetectionByAffiliation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_DetectionByAffiliation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_PeripheralVisionAngleDegrees = { UE4CodeGen_Private::EPropertyClass::Float, "PeripheralVisionAngleDegrees", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000014015, 1, nullptr, STRUCT_OFFSET(UAISenseConfig_Sight, PeripheralVisionAngleDegrees), METADATA_PARAMS(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_PeripheralVisionAngleDegrees_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_PeripheralVisionAngleDegrees_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_LoseSightRadius = { UE4CodeGen_Private::EPropertyClass::Float, "LoseSightRadius", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000014015, 1, nullptr, STRUCT_OFFSET(UAISenseConfig_Sight, LoseSightRadius), METADATA_PARAMS(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_LoseSightRadius_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_LoseSightRadius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_SightRadius = { UE4CodeGen_Private::EPropertyClass::Float, "SightRadius", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000014015, 1, nullptr, STRUCT_OFFSET(UAISenseConfig_Sight, SightRadius), METADATA_PARAMS(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_SightRadius_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_SightRadius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_Implementation = { UE4CodeGen_Private::EPropertyClass::Class, "Implementation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0014000002014015, 1, nullptr, STRUCT_OFFSET(UAISenseConfig_Sight, Implementation), Z_Construct_UClass_UAISense_Sight_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_Implementation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISenseConfig_Sight_Statics::NewProp_Implementation_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAISenseConfig_Sight_Statics::ClassParams = {
		...
		0x001010A4u,
		nullptr, 0,
		Z_Construct_UClass_UAISenseConfig_Sight_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UAISenseConfig_Sight_Statics::PropPointers),
		"Game",
	...
	IMPLEMENT_CLASS(UAISenseConfig_Sight, 2235262648);
