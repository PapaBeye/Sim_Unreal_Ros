...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAISightEvent
{
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_Observer = { UE4CodeGen_Private::EPropertyClass::Object, "Observer", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FAISightEvent, Observer), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_Observer_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_Observer_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_SeenActor_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Perception/AISense_Sight.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_SeenActor = { UE4CodeGen_Private::EPropertyClass::Object, "SeenActor", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FAISightEvent, SeenActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_SeenActor_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_SeenActor_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAISightEvent_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FAISightEvent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FAISightEvent_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FAISightEvent_CRC() { return 2649489893U; }
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_SightLimitQueryImportance = { UE4CodeGen_Private::EPropertyClass::Float, "SightLimitQueryImportance", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000014001, 1, nullptr, STRUCT_OFFSET(UAISense_Sight, SightLimitQueryImportance), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_SightLimitQueryImportance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_SightLimitQueryImportance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxQueryImportance = { UE4CodeGen_Private::EPropertyClass::Float, "MaxQueryImportance", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000014001, 1, nullptr, STRUCT_OFFSET(UAISense_Sight, MaxQueryImportance), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxQueryImportance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxQueryImportance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_HighImportanceQueryDistanceThreshold = { UE4CodeGen_Private::EPropertyClass::Float, "HighImportanceQueryDistanceThreshold", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000014001, 1, nullptr, STRUCT_OFFSET(UAISense_Sight, HighImportanceQueryDistanceThreshold), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_HighImportanceQueryDistanceThreshold_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_HighImportanceQueryDistanceThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTimeSlicePerTick = { UE4CodeGen_Private::EPropertyClass::Double, "MaxTimeSlicePerTick", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000014001, 1, nullptr, STRUCT_OFFSET(UAISense_Sight, MaxTimeSlicePerTick), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTimeSlicePerTick_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTimeSlicePerTick_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MinQueriesPerTimeSliceCheck = { UE4CodeGen_Private::EPropertyClass::Int, "MinQueriesPerTimeSliceCheck", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000014001, 1, nullptr, STRUCT_OFFSET(UAISense_Sight, MinQueriesPerTimeSliceCheck), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MinQueriesPerTimeSliceCheck_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MinQueriesPerTimeSliceCheck_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTracesPerTick = { UE4CodeGen_Private::EPropertyClass::Int, "MaxTracesPerTick", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000014001, 1, nullptr, STRUCT_OFFSET(UAISense_Sight, MaxTracesPerTick), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTracesPerTick_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTracesPerTick_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAISense_Sight_Statics::ClassParams = {
		...
		0x001000A4u,
		nullptr, 0,
		Z_Construct_UClass_UAISense_Sight_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::PropPointers),
		"Game",
	...
	IMPLEMENT_CLASS(UAISense_Sight, 4123796921);
