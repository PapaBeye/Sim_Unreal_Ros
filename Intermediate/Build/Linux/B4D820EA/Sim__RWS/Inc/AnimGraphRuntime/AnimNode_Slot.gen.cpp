...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_Slot
{
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimNode_Slot_Statics::NewProp_SlotName = { UE4CodeGen_Private::EPropertyClass::Name, "SlotName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FAnimNode_Slot, SlotName), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_Slot_Statics::NewProp_SlotName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_Slot_Statics::NewProp_SlotName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_Slot_Statics::NewProp_Source = { UE4CodeGen_Private::EPropertyClass::Struct, "Source", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FAnimNode_Slot, Source), Z_Construct_UScriptStruct_FPoseLink, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_Slot_Statics::NewProp_Source_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_Slot_Statics::NewProp_Source_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAnimNode_Slot_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FAnimNode_Slot_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_Slot_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_Slot_CRC() { return 2656211076U; }
