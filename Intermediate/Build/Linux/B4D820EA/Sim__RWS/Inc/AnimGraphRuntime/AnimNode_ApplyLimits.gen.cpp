...
class UScriptStruct* FAnimNode_ApplyLimits::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_ApplyLimits"), sizeof(FAnimNode_ApplyLimits), Get_Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_ApplyLimits
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets = { UE4CodeGen_Private::EPropertyClass::Array, "AngularOffsets", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000045, 1, nullptr, STRUCT_OFFSET(FAnimNode_ApplyLimits, AngularOffsets), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "AngularOffsets", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularRangeLimits = { UE4CodeGen_Private::EPropertyClass::Array, "AngularRangeLimits", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FAnimNode_ApplyLimits, AngularRangeLimits), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularRangeLimits_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularRangeLimits_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularRangeLimits_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "AngularRangeLimits", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FAngularRangeLimit, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_AnimGraphRuntime();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("AnimNode_ApplyLimits"), sizeof(FAnimNode_ApplyLimits), Get_Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_CRC() { return 1092035470U; }
class UScriptStruct* FAngularRangeLimit::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API uint32 Get_Z_Construct_UScriptStruct_FAngularRangeLimit_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FAngularRangeLimit, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AngularRangeLimit"), sizeof(FAngularRangeLimit), Get_Z_Construct_UScriptStruct_FAngularRangeLimit_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAngularRangeLimit
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewProp_LimitMax = { UE4CodeGen_Private::EPropertyClass::Struct, "LimitMax", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FAngularRangeLimit, LimitMax), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewProp_LimitMax_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewProp_LimitMax_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewProp_LimitMin = { UE4CodeGen_Private::EPropertyClass::Struct, "LimitMin", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FAngularRangeLimit, LimitMin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewProp_LimitMin_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewProp_LimitMin_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FAngularRangeLimit_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_AnimGraphRuntime();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("AngularRangeLimit"), sizeof(FAngularRangeLimit), Get_Z_Construct_UScriptStruct_FAngularRangeLimit_CRC(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
	...
	uint32 Get_Z_Construct_UScriptStruct_FAngularRangeLimit_CRC() { return 3443770343U; }
