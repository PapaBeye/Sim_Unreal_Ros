...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_CopyBone
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_bCopyRotation = { UE4CodeGen_Private::EPropertyClass::Bool, "bCopyRotation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FAnimNode_CopyBone), &Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_bCopyRotation_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_bCopyRotation_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_bCopyRotation_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_bCopyTranslation = { UE4CodeGen_Private::EPropertyClass::Bool, "bCopyTranslation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FAnimNode_CopyBone), &Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_bCopyTranslation_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_bCopyTranslation_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_bCopyTranslation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_TargetBone = { UE4CodeGen_Private::EPropertyClass::Struct, "TargetBone", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FAnimNode_CopyBone, TargetBone), Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_TargetBone_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_TargetBone_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_SourceBone = { UE4CodeGen_Private::EPropertyClass::Struct, "SourceBone", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FAnimNode_CopyBone, SourceBone), Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_SourceBone_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::NewProp_SourceBone_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_CopyBone_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_CopyBone_CRC() { return 1017157158U; }
