...
class UScriptStruct* FAnimNode_StateResult::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API uint32 Get_Z_Construct_UScriptStruct_FAnimNode_StateResult_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_StateResult, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_StateResult"), sizeof(FAnimNode_StateResult), Get_Z_Construct_UScriptStruct_FAnimNode_StateResult_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_StateResult
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FAnimNode_StateResult_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_AnimGraphRuntime();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("AnimNode_StateResult"), sizeof(FAnimNode_StateResult), Get_Z_Construct_UScriptStruct_FAnimNode_StateResult_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_StateResult_CRC() { return 1490204902U; }
