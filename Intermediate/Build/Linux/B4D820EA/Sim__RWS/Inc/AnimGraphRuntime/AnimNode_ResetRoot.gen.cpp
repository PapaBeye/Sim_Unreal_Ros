...
class UScriptStruct* FAnimNode_ResetRoot::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ResetRoot_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_ResetRoot, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_ResetRoot"), sizeof(FAnimNode_ResetRoot), Get_Z_Construct_UScriptStruct_FAnimNode_ResetRoot_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_ResetRoot
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ResetRoot_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_AnimGraphRuntime();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("AnimNode_ResetRoot"), sizeof(FAnimNode_ResetRoot), Get_Z_Construct_UScriptStruct_FAnimNode_ResetRoot_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ResetRoot_CRC() { return 591474140U; }
