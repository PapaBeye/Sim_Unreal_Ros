...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_MeshDescription_EComputeNTBsOptions_CRC() { return 3772498695U; }
	UEnum* Z_Construct_UEnum_MeshDescription_EComputeNTBsOptions()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_MeshDescription();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EComputeNTBsOptions"), 0, Get_Z_Construct_UEnum_MeshDescription_EComputeNTBsOptions_CRC(), false);
#else
...
class UScriptStruct* FMeshTriangle::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MESHDESCRIPTION_API uint32 Get_Z_Construct_UScriptStruct_FMeshTriangle_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMeshTriangle, Z_Construct_UPackage__Script_MeshDescription(), TEXT("MeshTriangle"), sizeof(FMeshTriangle), Get_Z_Construct_UScriptStruct_FMeshTriangle_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_MeshDescription_StaticRegisterNativesFMeshTriangle
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMeshTriangle_Statics::NewProp_VertexInstanceID1 = { UE4CodeGen_Private::EPropertyClass::Struct, "VertexInstanceID1", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000004, 1, nullptr, STRUCT_OFFSET(FMeshTriangle, VertexInstanceID1), Z_Construct_UScriptStruct_FVertexInstanceID, METADATA_PARAMS(Z_Construct_UScriptStruct_FMeshTriangle_Statics::NewProp_VertexInstanceID1_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshTriangle_Statics::NewProp_VertexInstanceID1_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMeshTriangle_Statics::NewProp_VertexInstanceID0 = { UE4CodeGen_Private::EPropertyClass::Struct, "VertexInstanceID0", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000004, 1, nullptr, STRUCT_OFFSET(FMeshTriangle, VertexInstanceID0), Z_Construct_UScriptStruct_FVertexInstanceID, METADATA_PARAMS(Z_Construct_UScriptStruct_FMeshTriangle_Statics::NewProp_VertexInstanceID0_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshTriangle_Statics::NewProp_VertexInstanceID0_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMeshTriangle_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMeshTriangle_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshTriangle_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FMeshTriangle_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_MeshDescription();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("MeshTriangle"), sizeof(FMeshTriangle), Get_Z_Construct_UScriptStruct_FMeshTriangle_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FMeshTriangle_CRC() { return 3661677821U; }
	...
	IMPLEMENT_CLASS(UDEPRECATED_MeshDescription, 1353897364);
