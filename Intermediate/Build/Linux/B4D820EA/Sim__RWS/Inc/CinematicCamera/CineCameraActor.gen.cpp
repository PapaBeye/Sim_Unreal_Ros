...
static struct FScriptStruct_CinematicCamera_StaticRegisterNativesFCameraLookatTrackingSettings
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bAllowRoll = { UE4CodeGen_Private::EPropertyClass::Bool, "bAllowRoll", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000200000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FCameraLookatTrackingSettings), &Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bAllowRoll_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bAllowRoll_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bAllowRoll_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_RelativeOffset = { UE4CodeGen_Private::EPropertyClass::Struct, "RelativeOffset", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000200000005, 1, nullptr, STRUCT_OFFSET(FCameraLookatTrackingSettings, RelativeOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_RelativeOffset_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_RelativeOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_ActorToTrack = { UE4CodeGen_Private::EPropertyClass::Object, "ActorToTrack", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000200000005, 1, nullptr, STRUCT_OFFSET(FCameraLookatTrackingSettings, ActorToTrack), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_ActorToTrack_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_ActorToTrack_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_LookAtTrackingInterpSpeed = { UE4CodeGen_Private::EPropertyClass::Float, "LookAtTrackingInterpSpeed", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FCameraLookatTrackingSettings, LookAtTrackingInterpSpeed), METADATA_PARAMS(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_LookAtTrackingInterpSpeed_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_LookAtTrackingInterpSpeed_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bEnableLookAtTracking = { UE4CodeGen_Private::EPropertyClass::Bool, "bEnableLookAtTracking", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000200000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FCameraLookatTrackingSettings), &Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bEnableLookAtTracking_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bEnableLookAtTracking_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bEnableLookAtTracking_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_CRC() { return 3778599611U; }
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ACineCameraActor_GetCineCameraComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ACineCameraActor, "GetCineCameraComponent", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x54020401, sizeof(CineCameraActor_eventGetCineCameraComponent_Parms), Z_Construct_UFunction_ACineCameraActor_GetCineCameraComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ACineCameraActor_GetCineCameraComponent_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ACineCameraActor_GetCineCameraComponent_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ACineCameraActor_GetCineCameraComponent_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACineCameraActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACineCameraActor_GetCineCameraComponent, "GetCineCameraComponent" }, // 3822633753
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ACineCameraActor_Statics::ClassParams = {
		...
		Z_Construct_UClass_ACineCameraActor_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_ACineCameraActor_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(ACineCameraActor, 1769765859);
