...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_ExpressionGUID = { UE4CodeGen_Private::EPropertyClass::Struct, "ExpressionGUID", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionLandscapeLayerSwitch, ExpressionGUID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_ExpressionGUID_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_ExpressionGUID_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_PreviewUsed = { UE4CodeGen_Private::EPropertyClass::Bool, "PreviewUsed", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UMaterialExpressionLandscapeLayerSwitch), &Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_PreviewUsed_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_PreviewUsed_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_PreviewUsed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_LayerNotUsed = { UE4CodeGen_Private::EPropertyClass::Struct, "LayerNotUsed", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionLandscapeLayerSwitch, LayerNotUsed), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_LayerNotUsed_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_LayerNotUsed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_LayerUsed = { UE4CodeGen_Private::EPropertyClass::Struct, "LayerUsed", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionLandscapeLayerSwitch, LayerUsed), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_LayerUsed_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::NewProp_LayerUsed_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::ClassParams = {
		...
		0x001020A0u,
		nullptr, 0,
		Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionLandscapeLayerSwitch_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMaterialExpressionLandscapeLayerSwitch, 2048951058);
