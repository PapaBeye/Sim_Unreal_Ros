...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UControlPointMeshComponent_Statics::NewProp_bSelected = { UE4CodeGen_Private::EPropertyClass::Bool, "bSelected", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000800002000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UControlPointMeshComponent), &Z_Construct_UClass_UControlPointMeshComponent_Statics::NewProp_bSelected_SetBit, METADATA_PARAMS(Z_Construct_UClass_UControlPointMeshComponent_Statics::NewProp_bSelected_MetaData, ARRAY_COUNT(Z_Construct_UClass_UControlPointMeshComponent_Statics::NewProp_bSelected_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UControlPointMeshComponent_Statics::ClassParams = {
		...
		0x00A810A4u,
		nullptr, 0,
		IF_WITH_EDITORONLY_DATA(Z_Construct_UClass_UControlPointMeshComponent_Statics::PropPointers, nullptr), IF_WITH_EDITORONLY_DATA(ARRAY_COUNT(Z_Construct_UClass_UControlPointMeshComponent_Statics::PropPointers), 0),
		"Engine",
	...
	IMPLEMENT_CLASS(UControlPointMeshComponent, 739361350);
