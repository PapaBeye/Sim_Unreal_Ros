...
static struct FScriptStruct_AnimationCore_StaticRegisterNativesFNodeChain
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes = { UE4CodeGen_Private::EPropertyClass::Array, "Nodes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FNodeChain, Nodes), METADATA_PARAMS(Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes_MetaData)) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes_Inner = { UE4CodeGen_Private::EPropertyClass::Name, "Nodes", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNodeChain_Statics::ReturnStructParams = {
		...
		sizeof(FNodeChain),
		alignof(FNodeChain),
		Z_Construct_UScriptStruct_FNodeChain_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FNodeChain_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FNodeChain_CRC() { return 2366575269U; }
