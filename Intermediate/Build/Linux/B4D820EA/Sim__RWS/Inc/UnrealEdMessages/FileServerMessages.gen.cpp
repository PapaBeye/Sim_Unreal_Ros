...
static struct FScriptStruct_UnrealEdMessages_StaticRegisterNativesFFileServerReady
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FFileServerReady_Statics::NewProp_AddressList = { UE4CodeGen_Private::EPropertyClass::Array, "AddressList", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FFileServerReady, AddressList), METADATA_PARAMS(Z_Construct_UScriptStruct_FFileServerReady_Statics::NewProp_AddressList_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FFileServerReady_Statics::NewProp_AddressList_MetaData)) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FFileServerReady_Statics::NewProp_AddressList_Inner = { UE4CodeGen_Private::EPropertyClass::Str, "AddressList", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFileServerReady_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FFileServerReady_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FFileServerReady_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FFileServerReady_CRC() { return 1751450837U; }
