...
static struct FScriptStruct_UnrealEdMessages_StaticRegisterNativesFAssetEditorRequestOpenAsset
{
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAssetEditorRequestOpenAsset_Statics::NewProp_AssetName = { UE4CodeGen_Private::EPropertyClass::Str, "AssetName", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FAssetEditorRequestOpenAsset, AssetName), METADATA_PARAMS(Z_Construct_UScriptStruct_FAssetEditorRequestOpenAsset_Statics::NewProp_AssetName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetEditorRequestOpenAsset_Statics::NewProp_AssetName_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAssetEditorRequestOpenAsset_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FAssetEditorRequestOpenAsset_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetEditorRequestOpenAsset_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FAssetEditorRequestOpenAsset_CRC() { return 525907772U; }
