...
class UScriptStruct* FMovieSceneActorReferenceData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MOVIESCENETRACKS_API uint32 Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceData_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneActorReferenceData, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneActorReferenceData"), sizeof(FMovieSceneActorReferenceData), Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceData_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneActorReferenceData
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneActorReferenceData_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneActorReferenceData_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneActorReferenceData_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceData_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_MovieSceneTracks();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("MovieSceneActorReferenceData"), sizeof(FMovieSceneActorReferenceData), Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceData_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceData_CRC() { return 2889929498U; }
class UScriptStruct* FMovieSceneActorReferenceKey::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern MOVIESCENETRACKS_API uint32 Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceKey_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneActorReferenceKey, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneActorReferenceKey"), sizeof(FMovieSceneActorReferenceKey), Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceKey_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneActorReferenceKey
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneActorReferenceKey_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneActorReferenceKey_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneActorReferenceKey_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceKey_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_MovieSceneTracks();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("MovieSceneActorReferenceKey"), sizeof(FMovieSceneActorReferenceKey), Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceKey_CRC(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneActorReferenceKey_CRC() { return 2793594551U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorGuidStrings = { UE4CodeGen_Private::EPropertyClass::Array, "ActorGuidStrings", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000020000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneActorReferenceSection, ActorGuidStrings_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorGuidStrings_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorGuidStrings_MetaData)) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorGuidStrings_Inner = { UE4CodeGen_Private::EPropertyClass::Str, "ActorGuidStrings", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000020000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorGuidIndexCurve = { UE4CodeGen_Private::EPropertyClass::Struct, "ActorGuidIndexCurve", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000020000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneActorReferenceSection, ActorGuidIndexCurve_DEPRECATED), Z_Construct_UScriptStruct_FIntegralCurve, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorGuidIndexCurve_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorGuidIndexCurve_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorReferenceData = { UE4CodeGen_Private::EPropertyClass::Struct, "ActorReferenceData", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneActorReferenceSection, ActorReferenceData), Z_Construct_UScriptStruct_FMovieSceneActorReferenceData, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorReferenceData_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::NewProp_ActorReferenceData_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::ClassParams = {
		...
		0x002800A0u,
		nullptr, 0,
		Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneActorReferenceSection_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMovieSceneActorReferenceSection, 916079468);
