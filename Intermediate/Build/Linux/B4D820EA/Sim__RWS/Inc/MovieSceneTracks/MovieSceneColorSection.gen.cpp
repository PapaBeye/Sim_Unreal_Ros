...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneColorKeyStruct
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneColorKeyStruct_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneColorKeyStruct_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneColorKeyStruct_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneColorKeyStruct_CRC() { return 4057133829U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_AlphaCurve = { UE4CodeGen_Private::EPropertyClass::Struct, "AlphaCurve", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneColorSection, AlphaCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_AlphaCurve_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_AlphaCurve_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_BlueCurve = { UE4CodeGen_Private::EPropertyClass::Struct, "BlueCurve", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneColorSection, BlueCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_BlueCurve_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_BlueCurve_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_GreenCurve = { UE4CodeGen_Private::EPropertyClass::Struct, "GreenCurve", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneColorSection, GreenCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_GreenCurve_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_GreenCurve_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_RedCurve = { UE4CodeGen_Private::EPropertyClass::Struct, "RedCurve", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneColorSection, RedCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_RedCurve_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_RedCurve_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneColorSection_Statics::ClassParams = {
		...
		0x002800A0u,
		nullptr, 0,
		Z_Construct_UClass_UMovieSceneColorSection_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMovieSceneColorSection, 3413423609);
