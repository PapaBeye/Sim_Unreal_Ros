...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::NewProp_ConstraintSections = { UE4CodeGen_Private::EPropertyClass::Array, "ConstraintSections", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020088000000008, 1, nullptr, STRUCT_OFFSET(UMovieScene3DConstraintTrack, ConstraintSections), METADATA_PARAMS(Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::NewProp_ConstraintSections_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::NewProp_ConstraintSections_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::NewProp_ConstraintSections_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "ConstraintSections", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000080008, 1, nullptr, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::ClassParams = {
		...
		0x00A800A0u,
		nullptr, 0,
		Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UMovieScene3DConstraintTrack, 2716835002);
