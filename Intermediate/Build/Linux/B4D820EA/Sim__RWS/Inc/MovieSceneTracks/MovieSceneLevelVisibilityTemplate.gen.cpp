...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneLevelVisibilitySectionTemplate
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::NewProp_LevelNames = { UE4CodeGen_Private::EPropertyClass::Array, "LevelNames", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneLevelVisibilitySectionTemplate, LevelNames), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::NewProp_LevelNames_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::NewProp_LevelNames_MetaData)) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::NewProp_LevelNames_Inner = { UE4CodeGen_Private::EPropertyClass::Name, "LevelNames", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::NewProp_Visibility = { UE4CodeGen_Private::EPropertyClass::Enum, "Visibility", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneLevelVisibilitySectionTemplate, Visibility), Z_Construct_UEnum_MovieSceneTracks_ELevelVisibility, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::NewProp_Visibility_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::NewProp_Visibility_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneLevelVisibilitySectionTemplate_CRC() { return 1847532397U; }
