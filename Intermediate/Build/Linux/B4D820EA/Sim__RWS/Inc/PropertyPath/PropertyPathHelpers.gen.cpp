...
class UScriptStruct* FCachedPropertyPath::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern PROPERTYPATH_API uint32 Get_Z_Construct_UScriptStruct_FCachedPropertyPath_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FCachedPropertyPath, Z_Construct_UPackage__Script_PropertyPath(), TEXT("CachedPropertyPath"), sizeof(FCachedPropertyPath), Get_Z_Construct_UScriptStruct_FCachedPropertyPath_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_PropertyPath_StaticRegisterNativesFCachedPropertyPath
{
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_CachedFunction = { UE4CodeGen_Private::EPropertyClass::Object, "CachedFunction", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FCachedPropertyPath, CachedFunction), Z_Construct_UClass_UFunction, METADATA_PARAMS(Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_CachedFunction_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_CachedFunction_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_Segments = { UE4CodeGen_Private::EPropertyClass::Array, "Segments", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FCachedPropertyPath, Segments), METADATA_PARAMS(Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_Segments_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_Segments_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_Segments_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "Segments", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FPropertyPathSegment, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FCachedPropertyPath_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_PropertyPath();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("CachedPropertyPath"), sizeof(FCachedPropertyPath), Get_Z_Construct_UScriptStruct_FCachedPropertyPath_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FCachedPropertyPath_CRC() { return 1614205439U; }
class UScriptStruct* FPropertyPathSegment::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern PROPERTYPATH_API uint32 Get_Z_Construct_UScriptStruct_FPropertyPathSegment_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FPropertyPathSegment, Z_Construct_UPackage__Script_PropertyPath(), TEXT("PropertyPathSegment"), sizeof(FPropertyPathSegment), Get_Z_Construct_UScriptStruct_FPropertyPathSegment_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_PropertyPath_StaticRegisterNativesFPropertyPathSegment
{
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Field = { UE4CodeGen_Private::EPropertyClass::Object, "Field", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000002000, 1, nullptr, STRUCT_OFFSET(FPropertyPathSegment, Field), Z_Construct_UClass_UField, METADATA_PARAMS(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Field_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Field_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Struct = { UE4CodeGen_Private::EPropertyClass::Object, "Struct", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000002000, 1, nullptr, STRUCT_OFFSET(FPropertyPathSegment, Struct), Z_Construct_UClass_UStruct, METADATA_PARAMS(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Struct_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Struct_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_ArrayIndex = { UE4CodeGen_Private::EPropertyClass::Int, "ArrayIndex", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FPropertyPathSegment, ArrayIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_ArrayIndex_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_ArrayIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Name = { UE4CodeGen_Private::EPropertyClass::Name, "Name", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FPropertyPathSegment, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Name_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Name_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FPropertyPathSegment_CRC() { return 2451525722U; }
