...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USlateSettings_Statics::NewProp_bExplicitCanvasChildZOrder = { UE4CodeGen_Private::EPropertyClass::Bool, "bExplicitCanvasChildZOrder", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000004001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(USlateSettings), &Z_Construct_UClass_USlateSettings_Statics::NewProp_bExplicitCanvasChildZOrder_SetBit, METADATA_PARAMS(Z_Construct_UClass_USlateSettings_Statics::NewProp_bExplicitCanvasChildZOrder_MetaData, ARRAY_COUNT(Z_Construct_UClass_USlateSettings_Statics::NewProp_bExplicitCanvasChildZOrder_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USlateSettings_Statics::ClassParams = {
		...
		0x001000A6u,
		nullptr, 0,
		Z_Construct_UClass_USlateSettings_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_USlateSettings_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(USlateSettings, 4187386653);
