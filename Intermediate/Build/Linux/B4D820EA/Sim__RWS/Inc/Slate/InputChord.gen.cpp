...
static struct FScriptStruct_Slate_StaticRegisterNativesFInputChord
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bCmd = { UE4CodeGen_Private::EPropertyClass::Bool, "bCmd", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FInputChord), &Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bCmd_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bCmd_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bCmd_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bAlt = { UE4CodeGen_Private::EPropertyClass::Bool, "bAlt", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FInputChord), &Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bAlt_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bAlt_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bAlt_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bCtrl = { UE4CodeGen_Private::EPropertyClass::Bool, "bCtrl", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FInputChord), &Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bCtrl_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bCtrl_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bCtrl_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bShift = { UE4CodeGen_Private::EPropertyClass::Bool, "bShift", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FInputChord), &Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bShift_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bShift_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_bShift_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_Key = { UE4CodeGen_Private::EPropertyClass::Struct, "Key", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FInputChord, Key), Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_Key_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FInputChord_Statics::NewProp_Key_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FInputChord_Statics::ReturnStructParams = {
		...
		sizeof(FInputChord),
		alignof(FInputChord),
		Z_Construct_UScriptStruct_FInputChord_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FInputChord_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FInputChord_CRC() { return 1480257528U; }
