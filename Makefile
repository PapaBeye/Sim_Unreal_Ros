...
Sim__RWS-Linux-Debug:
	 $(PROJECTBUILD) Sim__RWS Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Sim__RWS-Linux-DebugGame:
	 $(PROJECTBUILD) Sim__RWS Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Sim__RWS-Linux-Shipping:
	 $(PROJECTBUILD) Sim__RWS Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Sim__RWS-Linux-Test:
	 $(PROJECTBUILD) Sim__RWS Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Sim__RWS:
	 $(PROJECTBUILD) Sim__RWS Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

Sim__RWSEditor-Linux-Debug:
	 $(PROJECTBUILD) Sim__RWSEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Sim__RWSEditor-Linux-DebugGame:
	 $(PROJECTBUILD) Sim__RWSEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Sim__RWSEditor-Linux-Shipping:
	 $(PROJECTBUILD) Sim__RWSEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Sim__RWSEditor-Linux-Test:
	 $(PROJECTBUILD) Sim__RWSEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Sim__RWSEditor:
	 $(PROJECTBUILD) Sim__RWSEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
