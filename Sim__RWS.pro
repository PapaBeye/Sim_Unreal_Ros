...
unrealRootPath=/home/papa/Desktop/unreal/UnrealEngine
Sim__RWSRootPath=/home/papa/Documents/Unreal Projects/Sim__RWS

gameProjectFile=/home/papa/Documents/Unreal Projects/Sim__RWS/Sim__RWS.uproject
...
include(Sim__RWSSource.pri)
include(Sim__RWSHeader.pri)
include(Sim__RWSConfig.pri)
include(Sim__RWSIncludes.pri)
include(Sim__RWSDefines.pri)
...
Sim__RWS-Linux-Debug.commands = $$build Sim__RWS Linux Debug  -project="\"$$gameProjectFile\"" $$args
Sim__RWS-Linux-DebugGame.commands = $$build Sim__RWS Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Sim__RWS-Linux-Shipping.commands = $$build Sim__RWS Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Sim__RWS-Linux-Test.commands = $$build Sim__RWS Linux Test  -project="\"$$gameProjectFile\"" $$args
Sim__RWS.commands = $$build Sim__RWS Linux Development  -project="\"$$gameProjectFile\"" $$args

Sim__RWSEditor-Linux-Debug.commands = $$build Sim__RWSEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
Sim__RWSEditor-Linux-DebugGame.commands = $$build Sim__RWSEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Sim__RWSEditor-Linux-Shipping.commands = $$build Sim__RWSEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Sim__RWSEditor-Linux-Test.commands = $$build Sim__RWSEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
Sim__RWSEditor.commands = $$build Sim__RWSEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	Sim__RWS-Linux-Debug \
	Sim__RWS-Linux-DebugGame \
	Sim__RWS-Linux-Shipping \
	Sim__RWS-Linux-Test \
	Sim__RWS \
	Sim__RWSEditor-Linux-Debug \
	Sim__RWSEditor-Linux-DebugGame \
	Sim__RWSEditor-Linux-Shipping \
	Sim__RWSEditor-Linux-Test \
	Sim__RWSEditor \
